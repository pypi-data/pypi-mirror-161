...
class DynamicSetting(object):
    ...
    def load_from_cache(self, version):
        print(f'{self.instance_id}: load from cache')
        try:
    ...
    def load_from_file(self):
        print(f'{self.instance_id}: load from file')
    ...
    def load_fallback(self):
        print(f'{self.instance_id}: load fallback')
    ...
    def download(self):
        ...
        try:
            ...
            self.logger('Response from url was no valid json')
            return
