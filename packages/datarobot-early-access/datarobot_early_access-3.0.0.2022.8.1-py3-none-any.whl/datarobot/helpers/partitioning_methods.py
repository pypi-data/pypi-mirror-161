        ...
        for key, val in kwargs.items():
            if hasattr(self, key):
                ...
                raise AttributeError(
                    f"DatetimePartitioningSpecification does not contain attribute `{key}`. \
See `datarobot.helpers.partitioning_methods.DatetimePartitioningSpecification` for all available \
