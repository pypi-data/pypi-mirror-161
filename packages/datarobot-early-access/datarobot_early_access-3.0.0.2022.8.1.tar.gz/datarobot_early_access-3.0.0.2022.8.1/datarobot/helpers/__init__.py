...
class AdvancedOptions:
    ...
    def __init__(
        ...
        response_cap: Optional[str] = None,
        blueprint_threshold: Optional[int] = None,
        seed: Optional[int] = None,
        smart_downsampled: bool = False,
