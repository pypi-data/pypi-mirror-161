...
- Added a new method to :class:`datarobot.models.Project` :meth:`Project.set_datetime_partitioning <datarobot.models.Project.set_datetime_partitioning>` which sets a partitioning method directly on a project instance for a time series project, as an alternative to passing one into :meth:`Project.set_target <datarobot.models.Project.set_target>`.
