...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, asset_contacts, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, entity_type, dashboard_id, last_modified_at, logical_id, source_info, upstream)
...
class KnowledgeCard:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCard':
        ...
        return KnowledgeCard(created_at, id, asset_contacts, asset_governed_tags, knowledge_card_created_at, deleted_at, entity_type, knowledge_card_id, knowledge_card_info, knowledge_card_validation, last_modified_at, logical_id)
...
class VirtualView:
    ...
    def from_dict(obj: Any) -> 'VirtualView':
        ...
        return VirtualView(created_at, id, asset_contacts, asset_governed_tags, virtual_view_created_at, dbt_model, deleted_at, entity_type, virtual_view_id, last_modified_at, logical_id, looker_explore, looker_view, ownership_assignment, power_bi_dataset, tableau_datasource, tag_assignment, thought_spot)
