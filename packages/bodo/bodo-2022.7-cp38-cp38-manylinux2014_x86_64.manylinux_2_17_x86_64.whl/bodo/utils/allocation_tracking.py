...
def get_allocation_stats():
    xhuc__gmiv = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    fgc__glpz, fqswj__iwvp, vui__pgx, sjg__iqy = 0, 0, 0, 0
    for ijs__npdc in xhuc__gmiv:
        fgc__glpz += ijs__npdc[0]
        fqswj__iwvp += ijs__npdc[1]
        vui__pgx += ijs__npdc[2]
        sjg__iqy += ijs__npdc[3]
    return fgc__glpz, fqswj__iwvp, vui__pgx, sjg__iqy
