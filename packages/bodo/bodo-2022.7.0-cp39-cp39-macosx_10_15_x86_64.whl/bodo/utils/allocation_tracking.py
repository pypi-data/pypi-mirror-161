...
def get_allocation_stats():
    vjja__ofkjc = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    zie__uhqvy, gqjp__vay, vhqq__mbzjb, vwa__mre = 0, 0, 0, 0
    for urn__azhdq in vjja__ofkjc:
        zie__uhqvy += urn__azhdq[0]
        gqjp__vay += urn__azhdq[1]
        vhqq__mbzjb += urn__azhdq[2]
        vwa__mre += urn__azhdq[3]
    return zie__uhqvy, gqjp__vay, vhqq__mbzjb, vwa__mre
