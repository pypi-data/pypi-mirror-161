...
def get_allocation_stats():
    xlxd__tzzo = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    ffj__hwr, pqw__uanwz, byg__tjpox, bgwx__ikiy = 0, 0, 0, 0
    for zwsz__fudvj in xlxd__tzzo:
        ffj__hwr += zwsz__fudvj[0]
        pqw__uanwz += zwsz__fudvj[1]
        byg__tjpox += zwsz__fudvj[2]
        bgwx__ikiy += zwsz__fudvj[3]
    return ffj__hwr, pqw__uanwz, byg__tjpox, bgwx__ikiy
