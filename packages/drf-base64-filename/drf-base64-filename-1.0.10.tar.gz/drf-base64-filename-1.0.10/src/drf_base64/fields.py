...
class NamedBase64FieldMixin(Base64FieldMixin):
    ...
    INVALID_FILE_NAME = (
        'The file name is incorrect. It should have the form "<name>.<extension>"'
    )
    INVALID_FILE_UPLOAD = (
        "The file uploaded directly is invalid, must have a name and size"
    )
    ALLOWED_TYPES = [
        "jpeg",
        "jpg",
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.help_text is None:
            self.help_text = (
                "Object containing the base64-encoded file along with the name"
            )
