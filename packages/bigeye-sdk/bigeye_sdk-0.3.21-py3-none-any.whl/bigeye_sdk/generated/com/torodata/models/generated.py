...
class MetricSuiteResponse(betterproto.Message):
    created_metrics: List["MetricConfiguration"] = betterproto.message_field(1)
    updated_metrics: List["MetricConfiguration"] = betterproto.message_field(2)
    deleted_metrics: List["MetricConfiguration"] = betterproto.message_field(3)
