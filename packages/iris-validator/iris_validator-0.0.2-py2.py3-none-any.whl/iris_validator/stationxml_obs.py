...
def _read_response_stage(stage_elem, _ns):
    ...
    for elem in type_elems:
        ...
        if stage_gain is not None and stage_gain_frequency is not None:
            ...
            # MTH: Modify to pass through decimation info if present
            return obspy.core.inventory.ResponseStage(
                ...
                decimation_factor=decimation_factor, decimation_offset=decimation_offset,
                decimation_delay=decimation_delay, decimation_correction=decimation_correction)
