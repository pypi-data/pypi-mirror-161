(self["webpackChunkdeephaven_ipywidgets"] = self["webpackChunkdeephaven_ipywidgets"] || []).push([["lib_widget_js"],{
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DeephavenView = exports.DeephavenModel = void 0;
const base_1 = __webpack_require__(/*! @jupyter-widgets/base */ "webpack/sharing/consume/default/@jupyter-widgets/base");
const log_1 = __importDefault(__webpack_require__(/*! @deephaven/log */ "webpack/sharing/consume/default/@deephaven/log/@deephaven/log"));
const version_1 = __webpack_require__(/*! ./version */ "./lib/version.js");
// Import the CSS
__webpack_require__(/*! ../css/widget.css */ "./css/widget.css");
const log = log_1.default.module('deephaven-ipywidgets.widget');
class DeephavenModel extends base_1.DOMWidgetModel {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: DeephavenModel.model_name, _model_module: DeephavenModel.model_module, _model_module_version: DeephavenModel.model_module_version, _view_name: DeephavenModel.view_name, _view_module: DeephavenModel.view_module, _view_module_version: DeephavenModel.view_module_version });
    }
}
exports.DeephavenModel = DeephavenModel;
DeephavenModel.serializers = Object.assign({}, base_1.DOMWidgetModel.serializers);
DeephavenModel.model_name = 'DeephavenModel';
DeephavenModel.model_module = version_1.MODULE_NAME;
DeephavenModel.model_module_version = version_1.MODULE_VERSION;
DeephavenModel.view_name = 'DeephavenView'; // Set to null if no view
DeephavenModel.view_module = version_1.MODULE_NAME; // Set to null if no view
DeephavenModel.view_module_version = version_1.MODULE_VERSION;
class DeephavenView extends base_1.DOMWidgetView {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    render() {
...
exports.DeephavenView = DeephavenView;
