...
py::array buffer(pcl::shared_ptr<PointCloud<PointT>> &cloud) {
...
template<typename T>
void defineBuffers(py::class_<PointCloud<T>, pcl::shared_ptr<PointCloud<T>>> &cls) {
//    cls.def
};

template<>
void defineBuffers<PointXYZ>(py::class_<PointCloud<PointXYZ>, pcl::shared_ptr<PointCloud<PointXYZ>>> &cls) {
...
template<>
void defineBuffers<PointXYZI>(py::class_<PointCloud<PointXYZI>, pcl::shared_ptr<PointCloud<PointXYZI>>> &cls) {
...
template<>
void defineBuffers<PointXYZL>(py::class_<PointCloud<PointXYZL>, pcl::shared_ptr<PointCloud<PointXYZL>>> &cls) {
...
template<>
void defineBuffers<Label>(py::class_<PointCloud<Label>, pcl::shared_ptr<PointCloud<Label>>> &cls) {
    cls.def_property_readonly("label", &buffer<uint32_t, Label, 0, 1>);
}

template<>
void defineBuffers<PointXYZRGBA>(py::class_<PointCloud<PointXYZRGBA>, pcl::shared_ptr<PointCloud<PointXYZRGBA>>> &cls) {
...
template<>
void defineBuffers<PointXYZRGB>(py::class_<PointCloud<PointXYZRGB>, pcl::shared_ptr<PointCloud<PointXYZRGB>>> &cls) {
...
template<>
void defineBuffers<PointXYZRGBL>(py::class_<PointCloud<PointXYZRGBL>, pcl::shared_ptr<PointCloud<PointXYZRGBL>>> &cls) {
...
template<>
void defineBuffers<PointXYZHSV>(py::class_<PointCloud<PointXYZHSV>, pcl::shared_ptr<PointCloud<PointXYZHSV>>> &cls) {
...
template<>
void defineBuffers<PointXY>(py::class_<PointCloud<PointXY>, pcl::shared_ptr<PointCloud<PointXY>>> &cls) {
...
template<>
void
defineBuffers<InterestPoint>(py::class_<PointCloud<InterestPoint>, pcl::shared_ptr<PointCloud<InterestPoint>>> &cls) {
...
template<>
void defineBuffers<Axis>(py::class_<PointCloud<Axis>, pcl::shared_ptr<PointCloud<Axis>>> &cls) {
...
template<>
void defineBuffers<Normal>(py::class_<PointCloud<Normal>, pcl::shared_ptr<PointCloud<Normal>>> &cls) {
...
template<>
void defineBuffers<PointNormal>(py::class_<PointCloud<PointNormal>, pcl::shared_ptr<PointCloud<PointNormal>>> &cls) {
...
template<>
void defineBuffers<PointXYZRGBNormal>(
        py::class_<PointCloud<PointXYZRGBNormal>, pcl::shared_ptr<PointCloud<PointXYZRGBNormal>>> &cls) {
...
template<>
void defineBuffers<PointXYZINormal>(
        py::class_<PointCloud<PointXYZINormal>, pcl::shared_ptr<PointCloud<PointXYZINormal>>> &cls) {
...
template<>
void defineBuffers<PointXYZLNormal>(
        py::class_<PointCloud<PointXYZLNormal>, pcl::shared_ptr<PointCloud<PointXYZLNormal>>> &cls) {
...
template<>
void defineBuffers<PointWithRange>(
        py::class_<PointCloud<PointWithRange>, pcl::shared_ptr<PointCloud<PointWithRange>>> &cls) {
...
template<>
void defineBuffers<PointWithViewpoint>(
        py::class_<PointCloud<PointWithViewpoint>, pcl::shared_ptr<PointCloud<PointWithViewpoint>>> &cls) {
...
template<>
void defineBuffers<MomentInvariants>(
        py::class_<PointCloud<MomentInvariants>, pcl::shared_ptr<PointCloud<MomentInvariants>>> &cls) {
...
template<>
void defineBuffers<PrincipalRadiiRSD>(
        py::class_<PointCloud<PrincipalRadiiRSD>, pcl::shared_ptr<PointCloud<PrincipalRadiiRSD>>> &cls) {
...
template<>
void defineBuffers<Boundary>(py::class_<PointCloud<Boundary>, pcl::shared_ptr<PointCloud<Boundary>>> &cls) {
    cls.def_property_readonly("boundary_point", &buffer<uint8_t, Boundary, 0, 1>);
}

template<>
void defineBuffers<PrincipalCurvatures>(
        py::class_<PointCloud<PrincipalCurvatures>, pcl::shared_ptr<PointCloud<PrincipalCurvatures>>> &cls) {
...
template<>
void defineBuffers<PFHSignature125>(
        py::class_<PointCloud<PFHSignature125>, pcl::shared_ptr<PointCloud<PFHSignature125>>> &cls) {
    cls.def_property_readonly("histogram", &buffer<float, PFHSignature125, 0, 125>);
}

template<>
void defineBuffers<PFHRGBSignature250>(
        py::class_<PointCloud<PFHRGBSignature250>, pcl::shared_ptr<PointCloud<PFHRGBSignature250>>> &cls) {
    cls.def_property_readonly("histogram", &buffer<float, PFHRGBSignature250, 0, 250>);
}

template<>
void defineBuffers<PPFSignature>(py::class_<PointCloud<PPFSignature>, pcl::shared_ptr<PointCloud<PPFSignature>>> &cls) {
...
template<>
void
defineBuffers<CPPFSignature>(py::class_<PointCloud<CPPFSignature>, pcl::shared_ptr<PointCloud<CPPFSignature>>> &cls) {
...
template<>
void defineBuffers<PPFRGBSignature>(
        py::class_<PointCloud<PPFRGBSignature>, pcl::shared_ptr<PointCloud<PPFRGBSignature>>> &cls) {
...
template<>
void defineBuffers<NormalBasedSignature12>(
        py::class_<PointCloud<NormalBasedSignature12>, pcl::shared_ptr<PointCloud<NormalBasedSignature12>>> &cls) {
    cls.def_property_readonly("values", &buffer<float, NormalBasedSignature12, 0, 12>);
}

template<>
void defineBuffers<FPFHSignature33>(
        py::class_<PointCloud<FPFHSignature33>, pcl::shared_ptr<PointCloud<FPFHSignature33>>> &cls) {
    cls.def_property_readonly("histogram", &buffer<float, FPFHSignature33, 0, 33>);
}

template<>
void defineBuffers<VFHSignature308>(
        py::class_<PointCloud<VFHSignature308>, pcl::shared_ptr<PointCloud<VFHSignature308>>> &cls) {
    cls.def_property_readonly("histogram", &buffer<float, VFHSignature308, 0, 308>);
}

template<>
void defineBuffers<GRSDSignature21>(
        py::class_<PointCloud<GRSDSignature21>, pcl::shared_ptr<PointCloud<GRSDSignature21>>> &cls) {
    cls.def_property_readonly("histogram", &buffer<float, GRSDSignature21, 0, 21>);
}

template<>
void defineBuffers<ESFSignature640>(
        py::class_<PointCloud<ESFSignature640>, pcl::shared_ptr<PointCloud<ESFSignature640>>> &cls) {
    cls.def_property_readonly("histogram", &buffer<float, ESFSignature640, 0, 640>);
}

template<>
void defineBuffers<BRISKSignature512>(
        py::class_<PointCloud<BRISKSignature512>, pcl::shared_ptr<PointCloud<BRISKSignature512>>> &cls) {
...
template<>
void defineBuffers<Narf36>(py::class_<PointCloud<Narf36>, pcl::shared_ptr<PointCloud<Narf36>>> &cls) {
...
template<>
void defineBuffers<IntensityGradient>(
        py::class_<PointCloud<IntensityGradient>, pcl::shared_ptr<PointCloud<IntensityGradient>>> &cls) {
...
template<>
void defineBuffers<PointWithScale>(
        py::class_<PointCloud<PointWithScale>, pcl::shared_ptr<PointCloud<PointWithScale>>> &cls) {
...
template<>
void defineBuffers<PointSurfel>(py::class_<PointCloud<PointSurfel>, pcl::shared_ptr<PointCloud<PointSurfel>>> &cls) {
...
template<>
void defineBuffers<ShapeContext1980>(
        py::class_<PointCloud<ShapeContext1980>, pcl::shared_ptr<PointCloud<ShapeContext1980>>> &cls) {
...
template<>
void defineBuffers<UniqueShapeContext1960>(
        py::class_<PointCloud<UniqueShapeContext1960>, pcl::shared_ptr<PointCloud<UniqueShapeContext1960>>> &cls) {
...
template<>
void defineBuffers<SHOT352>(py::class_<PointCloud<SHOT352>, pcl::shared_ptr<PointCloud<SHOT352>>> &cls) {
    cls.def_property_readonly("descriptor", &buffer<float, SHOT352, 0, 352>);
    cls.def_property_readonly("rf", &buffer<float, SHOT352, 352, 9>);
}

template<>
void defineBuffers<SHOT1344>(py::class_<PointCloud<SHOT1344>, pcl::shared_ptr<PointCloud<SHOT1344>>> &cls) {
...
template<>
void defineBuffers<PointUV>(py::class_<PointCloud<PointUV>, pcl::shared_ptr<PointCloud<PointUV>>> &cls) {
    cls.def_property_readonly("u", &buffer<float, PointUV, 0, 1>);
    cls.def_property_readonly("v", &buffer<float, PointUV, 1, 1>);
}

template<>
void defineBuffers<ReferenceFrame>(
        py::class_<PointCloud<ReferenceFrame>, pcl::shared_ptr<PointCloud<ReferenceFrame>>> &cls) {
...
template<>
void defineBuffers<PointDEM>(py::class_<PointCloud<PointDEM>, pcl::shared_ptr<PointCloud<PointDEM>>> &cls) {
