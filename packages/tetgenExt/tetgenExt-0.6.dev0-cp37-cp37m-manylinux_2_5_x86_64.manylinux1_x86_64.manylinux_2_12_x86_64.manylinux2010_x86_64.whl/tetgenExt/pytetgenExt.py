...
class TetGen:
    ...
    def tetrahedralize(
        ...
        steinerleft : int, optional
            ...
            -1 will allow tetgenExt to create an unlimited number of
        ...
        C++ program.  This is the relationship between tetgenExt switches
        ...
        try:
            self.node, self.elem, self.face, self.edge = _tetgenExt.Tetrahedralize(
                self.v,
                self.f,
                switches_str,
                plc,
