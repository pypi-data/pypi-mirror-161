...
__copyright__ = 'Apachi'
__author__ = 'saleh'

class Bot:
	def __init__(self, app_name, phone_number=None, auth=None, device=defaultDevice, welcome=True):
		if welcome != False:
			text : str = '\n\033[31m[*] \033[92mlibrary [root] for me and a friend module for saleh ! github.com/mester-root\n'
			for txt in text:
	...
	def run():
		...
		while num < number:
			...
			try:
				...
				print(f'\n\033[31m[1] \033[36mauth \033[31m/ \033[92mTrue \033[31m/\033[36m {auth} \033[31m/ \033[36m{date} \033[31m/ \033[36m ', str(num))
				with open('auths.txt', 'a') as true:
					true.write(auth+'\n')
			except:
				print(f'\n\033[31m[1] \033[36mauth \033[31m/ \033[35mFalse \033[31m/\033[36m {auth} \033[31m/ \033[36m{date} \033[31m/ \033[36m ', str(num))
			num += 1