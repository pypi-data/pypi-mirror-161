...
# TODO;
# - raise warning if standard field is missing
# - raise warning if no endpoint or collection endpoint
# - raise warning if operate property is used for  non-collection endpoint
