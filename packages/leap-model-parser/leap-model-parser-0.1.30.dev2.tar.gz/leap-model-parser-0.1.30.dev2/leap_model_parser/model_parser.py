...
class ModelParser:
    def __init__(self):
        ...
        self.custom_layers: Dict[str, Type[tf.keras.layers.Layer]] = {}
    ...
    def _get_k_model_from_pb_path(self, file_path: str):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            k_model = load_model(pb_folder_path, custom_objects=custom_objects)
        return k_model
    ...
    def convert_h5_model(self, file_path: str) -> Tuple[Dict[str, NodeResponse], Model]:
        ...
        if self.custom_layers is not None:
            custom_objects = self.custom_layers
        imported_model = load_model(file_path, custom_objects=custom_objects)
