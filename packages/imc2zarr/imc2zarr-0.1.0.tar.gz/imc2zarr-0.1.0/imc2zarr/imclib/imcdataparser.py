...
class ImcDataParser:
    ...
    def _read_txt_acquisition_data(self, q: Acquisition):
        ...
        fn_end = '{}_{}.txt'.format(q.get_property(DESCRIPTION), q.id)
        q.txt_fh = None
    ...
    def save_snapshot_image(self, obj, out_folder):
        ...
        if isinstance(obj, Slide):
            fn.append('Slide.jpg')
            start_offset.append(int(obj.get_property(IMAGESTARTOFFSET)) + IMAGE_START_OFFSET)
            end_offset.append(int(obj.get_property(IMAGEENDOFFSET)))
            ...
            start_offset.append(int(obj.get_property(BEFOREABLATIONIMAGESTARTOFFSET)) + IMAGE_START_OFFSET)
            end_offset.append(int(obj.get_property(BEFOREABLATIONIMAGEENDOFFSET)))
            fn.append('Acquisition_{}_After.png'.format(obj.id))
            start_offset.append(int(obj.get_property(AFTERABLATIONIMAGESTARTOFFSET)) + IMAGE_START_OFFSET)
            end_offset.append(int(obj.get_property(AFTERABLATIONIMAGEENDOFFSET)))
        if fn:
