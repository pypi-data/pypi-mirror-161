...
@task_deco('fs_put', function_timeout=20, concurrent_mode=4, concurrent_num=4, broker_kind=BrokerEnum.NSQ, specify_async_loop=asyncio.get_event_loop())
...
@task_deco('fs_get', function_timeout=60, concurrent_mode=4, concurrent_num=4, broker_kind=BrokerEnum.NSQ)
