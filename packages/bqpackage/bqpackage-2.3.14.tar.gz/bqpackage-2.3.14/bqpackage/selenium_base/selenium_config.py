...
class SeleniumConfig:
    ...
    def __init__(self, headless=False, proxy=False, storage=False, remote=False):
        ...
        if headless:
            chrome_options.set_capability('goog:chromeOptions',
                                          {'args': ['window-size=1359,901', '--incognito', '--headless']})
        else:
            chrome_options.set_capability('goog:chromeOptions',
                                          {'args': ['window-size=1359,901', '--incognito']})
