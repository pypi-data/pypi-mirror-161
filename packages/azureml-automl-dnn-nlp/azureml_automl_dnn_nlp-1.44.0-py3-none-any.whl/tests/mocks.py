...
def get_tokenizer_mock():
    tokenizer_path = os.path.join(Path(__file__).parent, "data", "tokenizer", "bert-base-cased")
    print(f'creating mock tokenizer from saved data path{tokenizer_path}')
