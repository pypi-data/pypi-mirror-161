...
def table_crawler(url: str, table_name='table', option='stdout', output_file_path='./', origin=False,
                  json_orient="columns", engine='requests', debug=False, process_list=None):
...
if __name__ == '__main__':
    table_crawler('https://blog.csdn.net/wz947324/article/details/80076496?ops_request_misc=%257B%2522request%255Fid'
                  '%2522%253A%2522165883969616781685373910%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522'
                  '%257D&request_id=165883969616781685373910&biz_id=0&utm_medium=distribute.pc_search_result.none'
                  '-task-blog-2~all~top_positive~default-1-80076496-null-null.142^v34^pc_rank_34,'
                  '185^v2^tag_show&utm_term=ascii%E7%A0%81%E5%AF%B9%E7%85%A7%E8%A1%A8&spm=1018.2226.3001.4187')
