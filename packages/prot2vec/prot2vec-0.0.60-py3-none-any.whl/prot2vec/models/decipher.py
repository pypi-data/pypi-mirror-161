...
def get_cnn_transformer_decipher_model(ciphers_n=100, seq_len=40, seq_depth=20, emb_size=256, n_layers=6, n_heads=8,
                                       ff_dim=512, activation='relu', dropout=0.1,
    ...
    x = Conv1D(emb_size, kernel_size, activation=activation, padding='same')(x)
    x = Dropout(dropout)(x)
