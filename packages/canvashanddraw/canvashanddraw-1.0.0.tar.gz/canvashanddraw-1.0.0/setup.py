...
from canvashanddraw.version import VERSION
...
if __name__ == "__main__":
  ...
  setup(
    name = 'canvashanddraw',            
    packages = ['canvashanddraw'],
    version = VERSION,          
    license='Apache 2.0',                   # Chose a license from here: https://help.github.com/articles/licensing-a-repository
    description = 'A package to draw a set of points in a canvas, and save it as a image or an animation as if it was drawn by a hand',
    long_description = README,
    long_description_content_type = 'text/markdown',
    author = 'Carlos A.',             
    author_email = 'caralla@upv.es',  
    url = 'https://github.com/dealfonso/pycanvashanddraw',
    ...
    entry_points = {
      'console_scripts' : [
        'canvashanddraw=canvashanddraw.main:main',
      ]
    },
  )
