...
def StratifiedSampling(input_dataframe):
...
def Sampling(input_dataframe,cluster_col):
  ...
  print("\n","Stratified Sampling")
  sample_size1,pvalue1,subsample1= StratifiedSampling(input_dataframe_StratifiedSampling)
  
  
  print("\n","Random Sampling")
  input_dataframe = pd.read_csv(filepath, header='infer')
  sample_size2,pvalue2,subsample2= RandomSampling(input_dataframe_RandomSampling)
  
  
  print("\n","Systematic Sampling")
  input_dataframe = pd.read_csv(filepath, header='infer')
  sample_size3,pvalue3,subsample3= SystematicSampling(input_dataframe_SystematicSampling)
  ...
  if cluster_col=="NULL":
    ...
    print("\n","Cluster Sampling")
    input_dataframe = pd.read_csv(filepath, header='infer')
    sample_size4,pvalue4,subsample4= ClusterSampling_Oversampling(input_dataframe_ClusterSampling_Oversampling,cluster_col)
...
# # Function: Sampling
# #print(df.head())
# #RandomSampling(input_dataframe)
# #SystematicSampling(input_dataframe)
# #StratifiedSampling(input_dataframe)
# #ClusterSampling_Oversampling(input_dataframe,'Sex')

# Sampling(input_dataframe,'Sex')
