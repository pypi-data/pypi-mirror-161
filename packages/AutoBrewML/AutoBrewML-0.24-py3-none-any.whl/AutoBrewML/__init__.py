...
def ClusterSampling_Oversampling(input_dataframe_orig,cluster_col):
  ...
  #Getting back Sample in original data form
  uniqueIndex = list(subsample['Index'].unique())
  subsample_orig= input_dataframe_orig[input_dataframe_orig.Index.isin(uniqueIndex)]

  return(Len_Sampleddataset,pvalues_average,subsample_orig)
...
#subsample_final,subsample_StratifiedSampling,subsample_RandomSampling,subsample_SystematicSampling,subsample_ClusterSampling_Oversampling=BrewSampling(input_dataframe,'Sex')
