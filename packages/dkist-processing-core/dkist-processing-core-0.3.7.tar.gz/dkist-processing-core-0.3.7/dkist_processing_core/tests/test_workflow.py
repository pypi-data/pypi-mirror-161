...
def test_workflow_metadata(workflow):
    ...
    """
    workflow_instance, category, name, version, tags = workflow
    ...
    assert sorted(json.loads(workflow_instance._dag_tags)) == sorted([tag for tag in tags])
...
def test_workflow_add_node(workflow_tasks, workflow):
    ...
    """
    workflow_instance, category, name, version, _ = workflow
...
def test_invalid_workflow_add_node(workflow):
    ...
    """
    workflow_instance, _, _, _, _ = workflow
