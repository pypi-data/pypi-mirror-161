...
class V1KubernetesClusterStatus(object):
    ...
    def __init__(self, azure: 'V1AzureClusterDriverStatus' = None, eks: 'V1EKSCusterDriverStatus' = None, ingress_ca_cert: 'str' = None, ingress_load_balancer_hostname: 'str' = None, ingress_load_balancer_ip: 'str' = None, monitoring_client_cert: 'str' = None, monitoring_client_key: 'str' = None, _configuration=None):  # noqa: E501
    ...
    def monitoring_client_cert(self, monitoring_client_cert: 'str'):
        ...
        """
        if (self._configuration.client_side_validation and
                monitoring_client_cert is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', monitoring_client_cert)):  # noqa: E501
            raise ValueError(r"Invalid value for `monitoring_client_cert`, must be a follow pattern or equal to `/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/`")  # noqa: E501
    ...
    def monitoring_client_key(self, monitoring_client_key: 'str'):
        ...
        """
        if (self._configuration.client_side_validation and
                monitoring_client_key is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', monitoring_client_key)):  # noqa: E501
            raise ValueError(r"Invalid value for `monitoring_client_key`, must be a follow pattern or equal to `/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/`")  # noqa: E501
