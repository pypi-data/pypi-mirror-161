...
class V1Run(object):
    ...
    def __init__(self, created_at: 'datetime' = None, description: 'str' = None, id: 'str' = None, name: 'str' = None, spec: 'V1RunSpec' = None, status: 'V1RunStatus' = None, updated_at: 'datetime' = None, _configuration=None):  # noqa: E501
    ...
    @property
    def id(self) -> 'str':
        """Gets the id of this V1Run.  # noqa: E501


        :return: The id of this V1Run.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id: 'str'):
        """Sets the id of this V1Run.


        :param id: The id of this V1Run.  # noqa: E501
        :type: str
        """
    ...
    def spec(self) -> 'V1RunSpec':
        """Gets the spec of this V1Run.  # noqa: E501


        :return: The spec of this V1Run.  # noqa: E501
        :rtype: V1RunSpec
        """
        return self._spec
    ...
    def spec(self, spec: 'V1RunSpec'):
        """Sets the spec of this V1Run.


        :param spec: The spec of this V1Run.  # noqa: E501
        :type: V1RunSpec
        """
    ...
    @status.setter
    def status(self, status: 'V1RunStatus'):
    ...
    def __eq__(self, other: 'V1Run') -> bool:
    ...
    def __ne__(self, other: 'V1Run') -> bool:
