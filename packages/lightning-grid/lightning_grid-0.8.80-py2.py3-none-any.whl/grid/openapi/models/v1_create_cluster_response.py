...
class V1CreateClusterResponse(object):
    ...
    def __init__(self, created_at: 'datetime' = None, id: 'str' = None, name: 'str' = None, spec: 'V1ClusterSpec' = None, status: 'V1ClusterStatus' = None, _configuration=None):  # noqa: E501
