...
class CfnGlobalReplicationGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        members: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, "CfnGlobalReplicationGroup.GlobalReplicationGroupMemberProperty"]]],
