...
from social_net_queries.connectors.api_connector import ApiConnector
from social_net_queries.utils import utils
from social_net_queries.utils.constants.api_graph_constants import (  # Fields; Operations
    ACCESS_TOKEN,
    GET_ACCOUNTS,
...
from social_net_queries.utils.constants.constants import (
    DATA,
    GET,
    ID,
    META_API_SECRET_KEY,
...
class MetaApiConnector(ApiConnector):
    ...
    def get_ig_top_media(self, ig_business_account_id: str, hashtag_id: str):
        ...
        Return
        -------
        ig_top_media_data: bool, dict | bool, error_message
