...
def main(
    ...
    Args:
        ...
        alpha (float, optional): Controls the regularization strength to prevent overfitting.
    ...
    if alpha == 0:  # Linear Regression using least square solution.
        ...
        opt_weights = np.concatenate((weights[:-1], np.array([bias])))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--alpha", help="Regularization factor between 0 and inf", type=float, default=0)
