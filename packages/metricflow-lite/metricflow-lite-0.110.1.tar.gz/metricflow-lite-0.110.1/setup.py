...
packages = \
['metricflow-lite',
 'metricflow-lite.metricflow',
 'metricflow-lite.metricflow.api',
 'metricflow-lite.metricflow.cli',
 'metricflow-lite.metricflow.configuration',
 'metricflow-lite.metricflow.constraints',
 'metricflow-lite.metricflow.dag',
 'metricflow-lite.metricflow.dataflow',
 'metricflow-lite.metricflow.dataflow.builder',
 'metricflow-lite.metricflow.dataset',
 'metricflow-lite.metricflow.engine',
 'metricflow-lite.metricflow.errors',
 'metricflow-lite.metricflow.execution',
 'metricflow-lite.metricflow.model',
 'metricflow-lite.metricflow.model.objects',
 'metricflow-lite.metricflow.model.objects.constraints',
 'metricflow-lite.metricflow.model.objects.elements',
 'metricflow-lite.metricflow.model.parsing',
 'metricflow-lite.metricflow.model.semantics',
 'metricflow-lite.metricflow.model.transformations',
 'metricflow-lite.metricflow.model.validations',
 'metricflow-lite.metricflow.naming',
 'metricflow-lite.metricflow.plan_conversion',
 'metricflow-lite.metricflow.protocols',
 'metricflow-lite.metricflow.query',
 'metricflow-lite.metricflow.sql',
 'metricflow-lite.metricflow.sql.optimizer',
 'metricflow-lite.metricflow.sql.render',
 'metricflow-lite.metricflow.sql_clients',
 'metricflow-lite.metricflow.telemetry',
 'metricflow-lite.metricflow.telemetry.handlers',
 'metricflow-lite.metricflow.test',
 'metricflow-lite.metricflow.test.api',
 'metricflow-lite.metricflow.test.cli',
 'metricflow-lite.metricflow.test.constraints',
 'metricflow-lite.metricflow.test.dataflow',
 'metricflow-lite.metricflow.test.dataflow.builder',
 'metricflow-lite.metricflow.test.dataset',
 'metricflow-lite.metricflow.test.execution',
 'metricflow-lite.metricflow.test.fixtures',
 'metricflow-lite.metricflow.test.integration',
 'metricflow-lite.metricflow.test.model',
 'metricflow-lite.metricflow.test.model.parsing',
 'metricflow-lite.metricflow.test.model.semantics',
 'metricflow-lite.metricflow.test.model.transformations',
 'metricflow-lite.metricflow.test.model.validations',
 'metricflow-lite.metricflow.test.plan_conversion',
 'metricflow-lite.metricflow.test.plan_conversion.dataflow_to_sql',
 'metricflow-lite.metricflow.test.plan_conversion.instance_converters',
 'metricflow-lite.metricflow.test.query',
 'metricflow-lite.metricflow.test.sql',
 'metricflow-lite.metricflow.test.sql.optimizer',
 'metricflow-lite.metricflow.test.sql_clients',
 'metricflow-lite.metricflow.test.telemetry',
 'metricflow-lite.metricflow.test.time',
 'metricflow-lite.metricflow.time']
...
{'': ['*'],
 'metricflow-lite': ['.git/*',
                     ...
                     '.github/workflows/*',
                     'assets/*',
                     'config-templates/salesforce/*'],
 'metricflow-lite.metricflow.cli': ['sample_models/*'],
 'metricflow-lite.metricflow.test': ['snapshots/test_column_pruner.py/SqlQueryPlan/*',
 ...
 'metricflow-lite.metricflow.test.fixtures': ['model_yamls/composite_identifier_model/*',
 ...
 'metricflow-lite.metricflow.test.integration': ['test_cases/*']}
