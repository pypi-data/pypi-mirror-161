...
RB.RichTextInlineEditorView = RB.InlineEditorView.extend({
  ...
  createField() {
    ...
    this.once('beginEdit', () => {
      ...
      const $markdownRef = $('<a class="markdown-info" target="_blank">').attr('href', "".concat(MANUAL_URL, "users/markdown/")).text(gettext("Markdown Reference")).setVisible(this.textEditor.richText).appendTo(this.$buttons);
