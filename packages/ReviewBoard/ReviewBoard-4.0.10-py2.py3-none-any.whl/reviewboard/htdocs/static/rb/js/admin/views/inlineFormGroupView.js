...
RB.Admin.InlineFormGroupView = Backbone.View.extend({
  ...
  render() {
    ...
    const $initialForms = $inlines.children("#id_".concat(prefix, "-INITIAL_FORMS"));
    const $maxNumForms = $inlines.children("#id_".concat(prefix, "-MAX_NUM_FORMS"));
    const $minNumForms = $inlines.children("#id_".concat(prefix, "-MIN_NUM_FORMS"));
    const $totalForms = $inlines.children("#id_".concat(prefix, "-TOTAL_FORMS"));
