...
RB.DiffReviewable = RB.AbstractReviewable.extend({
  ...
  _buildRenderedDiffURL() {
    ...
    const revisionPart = interdiffRevision ? "".concat(revision, "-").concat(interdiffRevision) : revision;
    const fileDiffPart = interFileDiffID ? "".concat(fileDiffID, "-").concat(interFileDiffID) : fileDiffID;
    let url = "".concat(reviewURL, "diff/").concat(revisionPart, "/fragment/").concat(fileDiffPart, "/");
