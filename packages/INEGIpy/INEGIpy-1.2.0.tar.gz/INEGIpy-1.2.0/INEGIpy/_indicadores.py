...
## Catalogo de Metadatos
    ...
    def catalogo_indicadores(self, 
        ...
        indicadores: str, opcional. Clave(s) de los indicadores a consultar. En caso de nom definirse se regresan todos los indicadores del banco.
        ----------
        
        Para más información visitar https://www.inegi.org.mx/servicios/api_indicadores.html

        '''
        if indicadores is None: indicadores = 'null'
        return self._consultar_catalogo('CL_INDICATOR', indicadores, banco)
    ...
    def consulta_metadatos(self, 
        ...
        Parametros
        -----------
        metadatos: DataFrame con las metadatos a consultar obtenido por la función obtener_df cuando metadatos = True. También acepta un diccionario equivalente.
        ----------
