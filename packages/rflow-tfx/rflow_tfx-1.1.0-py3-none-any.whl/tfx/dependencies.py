...
- NIGHTLY uses x.(y+1).0.dev version as README.ml-pipelines-sdk.md lower version constraint. tfx nightly
...
- GIT_MASTER uses github master branch URL of the dependency, which is useful
  ...
  branch HEAD.
- For the release, we use README.ml-pipelines-sdk.md range of version, which is also used as README.ml-pipelines-sdk.md default.
"""
import os
