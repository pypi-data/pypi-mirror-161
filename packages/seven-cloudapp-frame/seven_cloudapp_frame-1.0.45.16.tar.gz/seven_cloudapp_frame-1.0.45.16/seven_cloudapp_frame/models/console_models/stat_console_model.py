...
@LastEditTime: 2022-07-28 13:58:18
        ...
        while True:
            try:
                ...
                if mod_count == 1:
                    ...
                    stat_queue_list = stat_queue_model.get_list(f"process_count<10 and '{now_date}'>process_date and MOD(user_id,{mod_count})={mod_value}", order_by="process_date asc", limit="100")
