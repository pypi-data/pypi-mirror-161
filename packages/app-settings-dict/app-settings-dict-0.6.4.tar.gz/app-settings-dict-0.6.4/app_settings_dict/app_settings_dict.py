...
class Settings(DefaultsDict):
    def __init__(
        ...
        *,
        ...
        setting_loader: Callable[[Any], Any] = None,
        setting_dumper: Callable[[Any], Any] = None,
    ) -> None:
        ...
        ----------
        settings_file_path : str, None
            The absolute path to the settings file. Must be a JSON file.
        prompt_user_for_all_settings : Callable[[Settings], Settings], None
        ...
        setting_dumper : Callable[[Any], str], None
            ...
            objects.
        """
        if settings_file_path and not settings_file_path.endswith(".json"):
            raise ValueError("The settings file must be a json file.")
    ...
    def update(self, data: Dict[Any, Any]) -> None:  # type: ignore
    ...
    def save(self) -> None:
        ...
        if not self.settings_file_path:
            raise FileNotFoundError("A settings file name was not given.")
        __settings_file_path: str = self.settings_file_path
        dict_ = self.dump_to_dict()
        with open(__settings_file_path, "w", encoding="utf8") as file:
    ...
    def load(
        ...
        __settings_file_path: str = self.settings_file_path
        try:
            with open(__settings_file_path, "r", encoding="utf8") as file:
