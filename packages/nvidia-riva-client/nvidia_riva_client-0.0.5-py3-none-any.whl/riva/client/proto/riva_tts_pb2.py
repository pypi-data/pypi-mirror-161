...
_SYNTHESIZESPEECHRESPONSEMETADATA = DESCRIPTOR.message_types_by_name['SynthesizeSpeechResponseMetadata']
...
SynthesizeSpeechRequest = _reflection.GeneratedProtocolMessageType('SynthesizeSpeechRequest', (_message.Message,), {
  ...
  '__module__' : 'riva.proto.riva_tts_pb2'
...
SynthesizeSpeechResponseMetadata = _reflection.GeneratedProtocolMessageType('SynthesizeSpeechResponseMetadata', (_message.Message,), {
  'DESCRIPTOR' : _SYNTHESIZESPEECHRESPONSEMETADATA,
  '__module__' : 'riva.proto.riva_tts_pb2'
  # @@protoc_insertion_point(class_scope:nvidia.riva.tts.SynthesizeSpeechResponseMetadata)
  })
_sym_db.RegisterMessage(SynthesizeSpeechResponseMetadata)
...
_RIVASPEECHSYNTHESIS = DESCRIPTOR.services_by_name['RivaSpeechSynthesis']
