...
var IpywidgetVarView = widgets.DOMWidgetView.extend({
    ...
    render: function() {
        ...
        Object.defineProperty(this.el, 'tojs_callback', {
            value: function(callback){
                if (!this.el.hasAttribute('IpywidgetVarCallbackList')){
                    Object.defineProperty(this.el, 'IpywidgetVarCallbackList', {
                        value: [],
                        configurable: true
                        }
                    );                      
                }
                this.el.IpywidgetVarCallbackList.push(callback);
            }.bind(this),
            configurable: true
        });
    ...
    tojs_changed: function(){
        ...
        this.el.IpywidgetVarCallbackList.foreach(element => function(){
            element(JSON.parse(this.model.get('tojs'))); // python sends json
        });
    },
