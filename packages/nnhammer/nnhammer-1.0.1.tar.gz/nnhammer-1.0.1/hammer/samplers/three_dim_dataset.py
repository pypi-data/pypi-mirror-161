...
from hammer.samplers.coordinate_generator import BalancedCoordinateGenerator
from hammer.samplers.patch_picker import WeightedPatchPicker


class ThreeDDataset(metaclass=ABCMeta):
    """
