...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.pb_play, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_date, 0, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.pb_audio, 1, 4, 1, 1)
        self.pb_star = QtWidgets.QPushButton(self.frame)
        self.pb_star.setMinimumSize(QtCore.QSize(35, 35))
        self.pb_star.setMaximumSize(QtCore.QSize(35, 35))
        self.pb_star.setText("")
        self.pb_star.setFlat(True)
        self.pb_star.setObjectName("pb_star")
        self.gridLayout_2.addWidget(self.pb_star, 1, 2, 1, 1)
