...
bakershell_cert = {
    "keys": [
        {
            "e": "AQAB",
            "kid": "d61237d4-6b54-4fc5-b2a8-515819412811",
            "kty": "RSA",
            "n": "lhwfsPpWzBs0P-RdQW_qz5xNYzAtShMZTGQeegV2Rn-Tv62nZutHINLh6lf_dv5YVoYPzWyAfmnMTTIUaa2DZPiO9MZE8jUlbU2tzwweddjBG_ail4_IofB8fKxdzSaCYzgCXa8DZfDRnhSXA6DB_Tiw5Bo9H6TcCYvJoFMWwG6dB15qlbPPwGlgt7VbZ5kNNuu6V1zynkdemuekl7Gw_XBelu3zavhodQCvR9XboOW7Ba1Y5C_tfHXT0lcKnkKm9leU4bL6i7fBcbsUPA7sftvWZBbmI2EGUuHvnNPWBNf9-UHogYgQTcr5KveurlMprZSIboA9TXppEArv3PmSQQ",
        }
    ]
}
...
class SdkConfigCls:
    ...
    def auth_host(self) -> str:
        ...
        elif self.stage in ["prod", "production"] and self.package == "BAKERSHELL":
            return "https://auth.bakershell-api.com/v4"
        else:
            return ""
    ...
    def ntfn_host(self) -> str:
        if self.stage == "stg" and self.package == "revtel":
            ...
            return "https://notification.dsa-automation.com.tw/v4"
        elif self.stage in ["prod", "production"] and self.package == "BAKERSHELL":
            return "https://notification.bakershell-api.com/v4"
        else:
            return ""
