...
public:
  ...
  virtual variables* DeepClone(Serializer* serializer, ElaboratorListener* elab_listener, BaseClass* parent) const override = 0;
...
private:
  ...
  bool vpiConstantVariable_ = 0;

  bool vpiIsRandomized_ = 0;
