...
public:
  ...
  virtual nets* DeepClone(Serializer* serializer, ElaboratorListener* elab_listener, BaseClass* parent) const override = 0;
...
private:
  ...
  bool vpiExplicitVectored_ = 0;

  bool vpiStructUnionMember_ = 0;
