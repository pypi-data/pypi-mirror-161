...
#ifndef UHDM_IMPORT_H
#define UHDM_IMPORT_H
...
class import final : public typespec {
  UHDM_IMPLEMENT_RTTI(import, typespec)
public:
  // Implicit constructor used to initialize all members,
  // comment: import();
  virtual ~import() final = default;
  ...
  virtual import* DeepClone(Serializer* serializer, ElaboratorListener* elab_listener, BaseClass* parent) const override;

    unsigned int VpiType() const final { return uhdmimport; }
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return uhdmimport; }

protected:
  void DeepCopy(import* clone, Serializer* serializer,
...
typedef FactoryT<import> importFactory;


typedef FactoryT<std::vector<import *>> VectorOfimportFactory;
