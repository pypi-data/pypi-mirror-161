...
define("scheduler_enable", default=False, type=bool, help="Tornado任务调度")
define("scheduler_config", default={}, type=dict, help="Tornado任务调度配置")
define("scheduler_options", default={}, type=dict, help="Tornado任务调度选项")
...
class WebServer:
    ...
    def init_scheduler(self):
        options.scheduler = TornadoScheduler(gconfig=options.scheduler_config, **options.scheduler_options)
