...
from tcell_agent.instrumentation.better_ip_address import tcell_get_host, get_remote_address, get_reverse_proxy_header
...
def initialize_tcell_context(request):
    ...
    request._tcell_context.remote_address = get_remote_address(request.META)
    request._tcell_context.reverse_proxy_header_value = get_reverse_proxy_header(request.META)
...
def get_appsensor_meta(request):
    ...
    appsensor_meta.reverse_proxy_header_value = request._tcell_context.reverse_proxy_header_value
