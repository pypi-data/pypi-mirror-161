...
class HostUpdateParams(object):
    ...
    def __init__(self, host_role=None, host_name=None, disks_selected_config=None, machine_config_pool_name=None, ignition_endpoint_token=None, node_labels=None):  # noqa: E501
