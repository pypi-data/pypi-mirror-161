...
if __name__ == "__main__":
    ...
    folder = r"test\ghaemiyeh\epub\378"
    conv.inspect_tags_in_folder(folder,
                                extensions=["html", "htm"],
                                only_tag_names=False,
                                strip_attr=["name", "href", "title", "id"],
                                print_tags=True,)
                                #within_tag=("div", {"id": "content1"}))

##    conv.find_example_of_tag(folder, "p", attr={"style": "margin:0pt; border:0pt; height:1em"},
##                             n=15, incl_parent=True, extensions=["html", "htm"])
