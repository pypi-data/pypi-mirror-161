...
class WenxinError(Exception):
    def __init__(
        ...
        if http_body and hasattr(http_body, "decode"):
            try:
                ...
                http_body = (
                    ...
                    "Please report to support@WenxinAPI.com>"
                )
        ...
        self.organization = self.headers.get("WenxinAPI-organization", None)
    ...
    # the raw message returned by WenxinAPI's API. This was previously available
    ...
    def construct_error_object(self):
        ...
        return WenxinAPI.api_resources.error_object.ErrorObject.construct_from(
...
class PermissionError(WenxinError):
    pass
