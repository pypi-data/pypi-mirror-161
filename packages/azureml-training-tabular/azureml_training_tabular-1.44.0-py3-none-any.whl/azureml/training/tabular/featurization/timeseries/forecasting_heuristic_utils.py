...
def _log_warn_maybe(msg: str, exception: Optional[BaseException] = None) -> None:
    ...
    if exception is not None:
        logging_utilities.log_traceback(
            exception, logger, is_critical=False,
            override_error_msg="[NOTE!This is NOT a log from a RAISED exception. It's a call stack log of caught ex.]"
                               "[Masked as it may contain PII]"
        )
