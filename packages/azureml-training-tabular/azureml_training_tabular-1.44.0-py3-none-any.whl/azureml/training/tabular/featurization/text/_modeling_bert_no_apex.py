...
from ..._diagnostics.error_definitions import UserError
from ..._diagnostics.reference_codes import ReferenceCodes
from .._transformer_exceptions import (
    ModelingBertNoApexInvalidHiddenSizeException,
    ModelingBertNoApexNotIntOrStrException,
)
    ...
    def load_tf_weights_in_bert(model, config, tf_checkpoint_path):
        ...
        try:
            ...
            raise AzureMLError.create(
                UserError, target="load_tf_weights_in_bert", reference_code=ReferenceCodes._BERT_LOAD_TF
            )
