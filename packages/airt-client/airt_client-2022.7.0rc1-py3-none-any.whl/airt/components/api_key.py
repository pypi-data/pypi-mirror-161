...
class APIKey:
    ...
    def ls(
        ...
        url = f"/{user_id}/apikey?include_disabled={include_disabled}&offset={offset}&limit={limit}"
    ...
    @staticmethod
    def details(apikey: Union[int, str], otp: Optional[str] = None) -> pd.DataFrame:
