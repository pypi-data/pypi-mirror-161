...
def from_s3(
    ...
    region: Optional[str] = typer.Option(
        None,
        help="airt service AWS bucket region. If **None** (default value), then the **uri** bucket region will be used.",
    ),
...
def from_mysql(
    ...
    region: str = typer.Option(
        "eu-west-1",
        help="airt service AWS bucket region. If not passed, then **eu-west-1** will be used.",
    ),
