...
def disable(
    ...
    df = User.disable(user=formated_users, otp=otp)  # type: ignore
    df["created"] = helper.humanize_date(df["created"])
...
def enable(
    ...
    df = User.enable(user=formated_users, otp=otp)  # type: ignore
    df["created"] = helper.humanize_date(df["created"])
...
def disable(
    ...
    user: Optional[str] = typer.Option(
        ...
        "--user",
        "-u",
        help="Account user_id/username to disable MFA. If not passed, then the default value None will be used to disable SSO for the currently logged-in user.",
    ),
    otp: Optional[str] = typer.Option(
        None,
        "--otp",
