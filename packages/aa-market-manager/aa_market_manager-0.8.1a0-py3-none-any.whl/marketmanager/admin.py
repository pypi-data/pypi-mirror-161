...
from marketmanager.models import (
    ManagedWatchConfig, Order, PrivateConfig, PublicConfig, StatisticsConfig,
    Structure, WatchConfig, Webhook,
)
...
class ManagedWatchConfigAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ["managed_structure", "managed_structure_type", "managed_webhooks", "managed_debug_webhooks", "managed_solar_system", "managed_region"]
