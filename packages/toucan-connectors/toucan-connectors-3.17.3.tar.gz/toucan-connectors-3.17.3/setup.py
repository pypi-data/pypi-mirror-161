...
['toucan_connectors',
 ...
 'toucan_connectors.awsathena.storage.small_apps.athenaco.config',
 'toucan_connectors.awsathena.storage.small_apps.athenaco.config.preprocess',
 'toucan_connectors.awsathena.storage.small_apps.demo.config',
 'toucan_connectors.awsathena.storage.small_apps.demo.config.preprocess',
 'toucan_connectors.awsathena.storage.small_apps.new-demo.config',
 'toucan_connectors.awsathena.storage.small_apps.new-demo.config.preprocess',
...
{'': ['*'],
 ...
 'toucan_connectors.awsathena': ['logs/*',
                                 'storage/small_apps/athenaco/*',
                                 'storage/small_apps/athenaco/static_assets/*',
                                 'storage/small_apps/demo/data_sources/*',
                                 'storage/small_apps/demo/static_assets/*',
                                 'storage/small_apps/new-demo/data_sources/*',
                                 'storage/small_apps/new-demo/static_assets/*'],
 'toucan_connectors.awsathena.storage.small_apps.athenaco.config': ['live_queries/*']}
