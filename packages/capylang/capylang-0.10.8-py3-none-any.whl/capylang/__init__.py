...
import os
import requests
global __version__, __functions__, __latest__
__version__ = "0.10.8"
__latest__ = requests.get("https://capylang.anistick.com/version").text
...
Running Capylang directly results in invalid class usage. To be provided assistance while using Capylang, run capy.help() or see the commands below.
...
class capy(object):
  ...
  def __init__(self):
    print("Please do not call Capylang directly. Use help() for more info.")
  ...
  def update():
    print("Updating is in beta.")
    os.system(f"pip3 install capylang=={__latest__}")