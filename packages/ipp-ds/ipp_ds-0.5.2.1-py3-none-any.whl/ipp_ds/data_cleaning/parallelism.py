...
def applyParallel(dfGrouped,
    ...
    Args:
        dfGrouped (pd.DataFrame or zip): Objeto groupby do pandas ou zip(objeto groupby + axes do matplotlib) para plot_mode=True
        func: Funcao definida pelo usuario
        n_jobs: Numero de jobs a serem utilizados no calculo da funcao
        concat_results (bool): Se o usuario deseja que os resultados sejam concatenados e retornados num novo dataframe
    ...
    Returns:
        Se concat_results=True: pd.DataFrame: DataFrame com resultados calculados. Se False: dict: Dicionário com chave sendo o grupo e valor sendo o resultado da função do grupo especifico.
    """
