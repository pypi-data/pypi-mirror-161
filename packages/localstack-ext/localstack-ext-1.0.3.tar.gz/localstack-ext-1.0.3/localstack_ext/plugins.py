...
def set_default_providers_to_pro():
	C='pro';from localstack.services.plugins import SERVICE_PLUGINS as B;D=B.apis_with_provider(C);localstack_config.SERVICE_PROVIDER_CONFIG.bulk_set_provider_if_not_exists(D,C);E=['azure']
	for A in E:
