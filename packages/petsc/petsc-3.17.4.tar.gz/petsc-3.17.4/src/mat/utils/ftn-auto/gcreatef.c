...
PETSC_EXTERN void  matsetpreallocationcoo_(Mat A,PetscCount *ncoo, PetscInt coo_i[], PetscInt coo_j[], int *__ierr)
{
*__ierr = MatSetPreallocationCOO(
	(Mat)PetscToPointer((A) ),*ncoo,coo_i,coo_j);
}
PETSC_EXTERN void  matsetpreallocationcoolocal_(Mat A,PetscCount *ncoo,PetscInt coo_i[],PetscInt coo_j[], int *__ierr)
{
*__ierr = MatSetPreallocationCOOLocal(
	(Mat)PetscToPointer((A) ),*ncoo,coo_i,coo_j);
}
