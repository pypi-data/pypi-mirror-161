...
*__ierr = DMPlexMetricEnforceSPD(
	...
	(Vec)PetscToPointer((metricIn) ),*restrictSizes,*restrictAnisotropy,metricOut,determinant);
}
PETSC_EXTERN void  dmplexmetricnormalize_(DM dm,Vec metricIn,PetscBool *restrictSizes,PetscBool *restrictAnisotropy,Vec *metricOut, int *__ierr)
{
*__ierr = DMPlexMetricNormalize(
	(DM)PetscToPointer((dm) ),
	(Vec)PetscToPointer((metricIn) ),*restrictSizes,*restrictAnisotropy,metricOut);
}
...
*__ierr = DMPlexMetricAverage(
	(DM)PetscToPointer((dm) ),*numMetrics,weights,metrics,metricAvg);
}
...
*__ierr = DMPlexMetricAverage2(
	...
	(Vec)PetscToPointer((metric2) ),metricAvg);
}
...
*__ierr = DMPlexMetricAverage3(
	...
	(Vec)PetscToPointer((metric3) ),metricAvg);
}
...
*__ierr = DMPlexMetricIntersection(
	(DM)PetscToPointer((dm) ),*numMetrics,metrics,metricInt);
}
...
*__ierr = DMPlexMetricIntersection2(
	(DM)PetscToPointer((dm) ),
	(Vec)PetscToPointer((metric1) ),
	(Vec)PetscToPointer((metric2) ),metricInt);
}
...
*__ierr = DMPlexMetricIntersection3(
	...
	(Vec)PetscToPointer((metric1) ),
	(Vec)PetscToPointer((metric2) ),
	(Vec)PetscToPointer((metric3) ),metricInt);
}
#if defined(__cplusplus)
}
#endif
