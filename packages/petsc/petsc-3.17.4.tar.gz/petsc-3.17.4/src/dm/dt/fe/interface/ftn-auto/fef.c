...
PETSC_EXTERN void  petscfecreatelagrangebycell_(MPI_Fint * comm,PetscInt *dim,PetscInt *Nc,DMPolytopeType *ct,PetscInt *k,PetscInt *qorder,PetscFE *fem, int *__ierr)
{
*__ierr = PetscFECreateLagrangeByCell(
