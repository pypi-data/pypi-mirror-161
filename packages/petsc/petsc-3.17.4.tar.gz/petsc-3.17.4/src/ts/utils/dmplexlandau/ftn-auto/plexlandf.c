...
extern "C" {
#endif
PETSC_EXTERN void  dmplexlandauaddmaxwellians_(DM dm,Vec X,PetscReal *time,PetscReal temps[],PetscReal ns[],PetscInt *grid,PetscInt *b_id,void*actx, int *__ierr)
{
*__ierr = DMPlexLandauAddMaxwellians(
	(DM)PetscToPointer((dm) ),
	(Vec)PetscToPointer((X) ),*time,temps,ns,*grid,*b_id,actx);
}
