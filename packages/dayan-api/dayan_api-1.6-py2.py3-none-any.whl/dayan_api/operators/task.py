...
from dayan_api.exception import RayvisionError
...
class TaskOperator(object):
    ...
    def __init__(self, connect):
        ...
        Args:
            connect (dayan_api.api.connect.Connect): The connect instance.
    ...
    def submit_task_to_cc(self, task_id, option=None, param=None):
        if option:
            data = {
                "taskId": task_id,
                "option": option
