...
from dayan_api.constants import HEADERS
from dayan_api.exception import RayvisionAPIError
from dayan_api import signature
from dayan_api.validator import validate_data
from dayan_api.url import ApiUrl
from dayan_api.url import assemble_api_url
...
class Connect(object):
    ...
    def post(self, api_url, data=None, validator=True):
        ...
        Args:
            api_url (dayan_api.api.url.URL or str): The URL address of the
