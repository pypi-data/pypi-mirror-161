...
class array:
    ...
    def __to_array(data : array | list):
        if type(data) == list:
            return array(data)
        return data
    ...
    def __getitem__(self : array, other : int | slice | tuple) -> int | float | complex | set | dimension | fract | array:
...
def gcd(*args) -> int | array:
    ...
    if 3 == len(args):
        return gcd(n, args[2])
    if 3 < len(args):
        return gcd(n, eval("gcd%s" %str((args[2 : -1] + (args[-1],)))))
    return n

def lcm(*args) -> int | array:
    args_max = max(args)
    n = 1
    while True:
        for k in args:
...
@__memo
def Sigma(_roop_time, _first_value, _formula) -> int | float | complex | set | dimension | fract | array:
    ans = 0
...
@__memo
def Pi(_roop_time, _first_value, _formula) -> int | float | complex | set | dimension | fract | array:
    ans = 1
    for n in range(_first_value, _roop_time):
        ans *= eval(_formula)
    return ans
...
@__list
def complex_test(_x) -> bool | array | list:
    """
...
@__list
@__memo
def prime_test(_n) -> bool | array | list:
    """
...
@__list
@__memo
def prime_fact(_n : int) -> array | list:
    """
...
@__list
def div(_x : int | float | complex | dimension | fract | array | list,
        _y : int | float | complex | dimension | fract | array | list)\
          -> int | float | complex | dimension | fract | array | list:
    if _y == 0:
        if   0 < _x:
            return  inf()
        elif _x < 0:
...
@__list
def imag_part(_x : int | float | complex | dimension | fract | array | list) -> int | float | array | list:
    try:
        return _x.imag
    except:
        return 0
...
@__list
def real_part(_x : int | float | complex | dimension | fract | array | list) -> int | float | array | list:
    try:
        return _x.real
    except:
        return 0
...
@__list
def P(_n : int | float | complex | dimension | fract | array | list, 
      _k : int | float | complex | dimension | fract | array | list)\
        -> int | float | complex | dimension | fract | array | list:
    return factorial(_n) / factorial(_k)

@__list
def C(_n : int | float | complex | dimension | fract | array | list, 
      _k : int | float | complex | dimension | fract | array | list)\
        -> int | float | complex | dimension | fract | array | list:
...
@__list
@__memo
def exp(_x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    """
...
@__list
@__memo
def zeta(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    """
...
@__list
@__memo
def ln(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    ans = x - 1
    ans_Pi = 1
    for n in range(1, 200):
...
@__list
@__memo
def log10(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    return log(10, x)

@__list
@__memo
def log2(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    return log(2, x)

@__list
@__memo
def log(x : int | float | complex | dimension | fract | array | list,
        y : int | float | complex | dimension | fract | array | list)\
         -> int | float | complex | dimension | fract | array | list:
    return div(ln(y) , ln(x))

@__list
@__memo
def sqrt(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    return x ** 0.5

@__list
@__memo
def cube(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    return x ** 0.3333333333333333333333333333333333333333

@__list
@__memo
def radical(x : int | float | complex | dimension | fract | array | list, 
            y : int | float | complex | dimension | fract | array | list)\
             -> int | float | complex | dimension | fract | array | list:
    return y ** (1 / x)
...
@__pow
@__memo
def Gamma(x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    if real_part(x) < 0.5:
        ans = pi() / (sin(pi() * x) * Gamma(1 - x))
    else:
        x -= 1
        y = 0.99999999999980993
        for (i, pval) in enumerate(__Gamma_list):
            y += pval / (x + i + 1)
        t = x + len(__Gamma_list) - 0.5
        ans = sqrt(tau()) * t ** (x + 0.5) * exp(-t) * y
    return ans

@__list
@__memo
def factorial(_x : int | float | complex | dimension | fract | array | list) -> int | float | complex | dimension | fract | array | list:
    """
...
@__pow
@__memo
def sin(_θ : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    """
...
@__pow
@__memo
def cos(_θ : int | float | complex | dimension | fract | array | list, _n = 0) -> int | float | complex | dimension | fract | array | list:
    """
...
@__pow
@__memo
def tan(_θ : int | float | complex | dimension | fract | array | list, _n = 0) -> int | float | complex | dimension | fract | array | list:
    """
...
@__pow
@__memo
def csc(_θ : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    """
...
@__pow
@__memo
def sec(_θ : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return div(1 , cos(_θ))

@__list
@__pow
@__memo
def cot(_θ : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return div(1 , tan(_θ))
...
@__pow
@__memo
def asin(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
...
@__pow
@__memo
def acos(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
...
@__pow
@__memo
def atan(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
...
@__pow
@__memo
def acsc(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return asin(div(1 , _x))

@__list
@__pow
@__memo
def asec(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return acos(div(1 , _x))

@__list
@__pow
@__memo
def acot(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return atan(div(1 , _x))

@__list
@__pow
@__memo
def sinh(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return (exp(_x) - exp(-_x)) / 2

@__list
@__pow
@__memo
def cosh(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return (exp(_x) + exp(-_x)) / 2

@__list
@__pow
@__memo
def tanh(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return sinh(_x) / cosh(_x)

@__list
@__pow
@__memo
def csch(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return 1 / sinh(_x)

@__list
@__pow
@__memo
def sech(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return 1 / cosh(_x)

@__list
@__pow
@__memo
def coth(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return 1 / tanh(_x)

@__list
@__pow
@__memo
def asinh(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return ln(_x + sqrt((_x ** 2) + 1))

@__list
@__pow
@__memo
def acosh(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return ln(_x + sqrt((_x + 1) * (_x - 1)))

@__list
@__pow
@__memo
def atanh(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return ln((1 + _x) / (1 - _x)) / 2

@__list
@__pow
@__memo
def acsch(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return asinh(1 / _x)

@__list
@__pow
@__memo
def asech(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return acosh(1 / _x)

@__list
@__pow
@__memo
def acoth(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
    return atanh(1 / _x)

@__list
def radian(_θ) -> int | float | complex | dimension | fract | array | list:
    return _θ / 57.295779513082320876798154814105

@__list
def degrees(_θ) -> int | float | complex | dimension | fract | array | list:
    return _θ * 57.295779513082320876798154814105

@__list
@__pow
@__memo
def diganma(_x : int | float | complex | dimension | fract | array | list, _n : int | str = 0) -> int | float | complex | dimension | fract | array | list:
