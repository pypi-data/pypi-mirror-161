...
from logger_configuration.formatters import formatters
from logger_configuration.handlers import handlers


class DSLoggerConfig(BaseSettings):
    context: str = ""
...
def get_logger(context):
    dictConfig(DSLoggerConfig(context=context).dict())
