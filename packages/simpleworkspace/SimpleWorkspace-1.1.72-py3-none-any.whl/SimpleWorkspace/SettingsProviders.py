...
class SettingsManager_Base(ABC):
    _settingsPath = None
    _defaultSettings = {} #settings always falls back to this if file doesn't exist or can't be loaded
    ...
    def __Console_ChangeSettings(self):
        while True:
            ...
            for key in self.settings:
                _ConsoleHelper.LevelPrint(3, str(dictlist_count) + ". " + key + " : " + self.settings[key])
                dictlist.append(key)
                dictlist_count += 1
            ...
            if choice == "0":
                ...
                if IntChoice == None:
                    ...
                    _ConsoleHelper.LevelPrint(2, ">> " + self.settings[key])
    ...
    def Console_PrintSettingsMenu(self):
        while(True):
            ...
            if choice == "1":
                ...
                choice = _ConsoleHelper.LevelInput("-")
                if choice == "y":
                    _os.remove(self._settingsPath)
                    self.LoadSettings()
                    _ConsoleHelper.LevelPrint(1)
