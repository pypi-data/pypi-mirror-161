...
def get_digestible_energy_content_terms():
    """
    Find all "digestible energy content" `property` terms from the Glossary:
    https://hestia.earth/glossary?termType=property&query=digestible%20energy%20content
    ...
    terms = search({
        "bool": {
            ...
            "should": [
                {
                    "match_phrase_prefix": {
                        "name": "Digestible energy content"
                    }
                }
            ],
            "minimum_should_match": 1
