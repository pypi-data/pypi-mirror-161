...
from hestia_earth.models.utils.impact_assessment import convert_value_from_cycle, get_product, impact_country_value
...
def run(impact_assessment: dict):
    ...
    value = impact_country_value(
        MODEL, TERM_ID, impact_assessment, 'region-emission-OzoneFormationDamageToTerrestrialEcosystemsLCImpactCF.csv'
    )
