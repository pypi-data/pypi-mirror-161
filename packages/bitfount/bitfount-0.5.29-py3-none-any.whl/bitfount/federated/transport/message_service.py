...
class _AutoRetryMessageServiceStub:
    ...
    def __init__(self, orig: MessageServiceStub) -> None:
        ...
        self.StartTraining = _auto_retry_grpc(orig.StartTraining)
...
class _MessageService:
    ...
    def metadata(self) -> List[Tuple[str, str]]:
        ...
        if api_keys := self.session.api_keys:
            return [
        ...
        return [("token", cast(str, self.session.access_token))]
    ...
    async def setup_communication_with_pods(
        ...
        return communication_details.mailboxId, dict(
            communication_details.podMailboxIds
        )
