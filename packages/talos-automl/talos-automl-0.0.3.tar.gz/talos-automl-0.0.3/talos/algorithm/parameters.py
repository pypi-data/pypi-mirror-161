...
def set_params(command_line_args, create_files=True):
    ...
    if "PARAMETERS" in cmd_args:
        load_params(path.join(getcwd(), "talos", "parameters", cmd_args["PARAMETERS"]))
    ...
    if params["LOAD_STATE"]:
        ...
        """print(path.join("..", "grammars", params["GRAMMAR_FILE"]))
        print(path.join(path.dirname(path.abspath(__file__))))
        print(path.join(path.dirname(path.abspath(__file__)), "..", "grammars", params["GRAMMAR_FILE"]))
        print(params["GRAMMAR_FILE"])
        print("BNF_GRAMMAR START")
        print(params["BNF_GRAMMAR"])
        print("BNF_GRAMMAR END")"""
