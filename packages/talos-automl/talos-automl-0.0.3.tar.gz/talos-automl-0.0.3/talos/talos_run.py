...
from talos.talos import Talos
talos = Talos(anomaly_class = 0, normal_class = 1, multiobjective=True, performance_metric="training_time", multicore=False, algorithm = "iforest")
