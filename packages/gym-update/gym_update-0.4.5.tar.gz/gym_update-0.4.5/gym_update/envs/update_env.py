...
#take an action with the environment
  def step(self, action):
    ...
    return self.patients, f_e, rho_0, pat_noA[:, 1:3], rho_noA, f_noA, done
    
    
#reset state and horizon    
  def reset(self, return_info: bool = False, options: Optional[dict] = None,):  
    ...
    # 
    if not return_info and not options:
      return f_0, self.patients, rho_0, thetas_0
    else:
      return f_0, self.patients, rho_0, thetas_0, {}, {}                                                      
