...
"""
Snyk only support importing public projects. Note that due to limitation, snyk only art monitor a pulic project.
If want to craw the result, pls use SnykCrawler.
"""
