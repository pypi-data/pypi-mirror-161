...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = RecordingApi()
        api_instance.delete_recording  # this is an instance of the class Endpoint
        api_instance.delete_recording()  # this invokes api_instance.delete_recording.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_recording.callable or self.callable in this class
