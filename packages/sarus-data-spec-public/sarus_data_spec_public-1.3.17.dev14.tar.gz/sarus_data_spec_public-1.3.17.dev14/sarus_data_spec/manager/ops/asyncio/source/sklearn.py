...
async def create_model(scalar: st.Scalar) -> Any:
    ...
    model_mapping: Dict["sp.Scalar.Model.ModelClass.V", Any] = {
        ...
        sp.Scalar.Model.ModelClass.SK_FUNCTION_TRANSFORMER: preprocessing.FunctionTransformer,
        # cluster
        ...
        # compose
        sp.Scalar.Model.ModelClass.SK_COLUMN_TRANSFORMER: compose.ColumnTransformer,
        # ensemble
        ...
        # pipeline
        sp.Scalar.Model.ModelClass.SK_PIPELINE: pipeline.Pipeline,
        # xgb
