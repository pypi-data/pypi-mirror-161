...
def main():
    ...
    parser.add_argument('-case', 
                        ...
                        "Converts each tag string into the 'camel' (e.g., LoremIpsumDolorSitAmet), 'snake' (e.g., Lorem_ipsum_dolor_sit_amet), or 'kebab' case (e.g., Lorem-ipsum-dolor-sit-amet). \n"+
                        "Note: this will not affect any punctuation symbol defined in the filename format by the user.",
                        action="store", dest="case", type=str)
    parser.add_argument(
