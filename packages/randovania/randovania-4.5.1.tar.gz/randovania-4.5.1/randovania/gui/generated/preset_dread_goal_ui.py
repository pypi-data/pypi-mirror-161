...
class Ui_PresetDreadGoal(object):
    def setupUi(self, PresetDreadGoal):
        ...
        PresetDreadGoal.resize(580, 274)
    ...
    def retranslateUi(self, PresetDreadGoal):
        ...
        self.placement_label.setText(QCoreApplication.translate("PresetDreadGoal", u"<html><head/><body><p>The following options limit where Metroid DNA will be placed. If there's more DNA than prefered locations, then they'll be placed anywhere.</p></body></html>", None))
