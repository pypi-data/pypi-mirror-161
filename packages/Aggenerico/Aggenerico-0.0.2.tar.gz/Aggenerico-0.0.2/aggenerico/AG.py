...
class Temp_pool:
	def __call__(self, indiv):
		...
		return d
class Genetico:
	def __init__(self,individuo,geracao=3,indiv=10,indiv_selec=3,mutacao=0.3,cross=0.7,voltas=1,ordena='d',show_v=False,show_g=False,thread=multiprocessing.cpu_count()):
