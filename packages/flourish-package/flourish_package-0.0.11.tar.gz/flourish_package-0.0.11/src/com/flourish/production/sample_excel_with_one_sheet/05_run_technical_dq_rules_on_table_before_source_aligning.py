...
run_dq_rules_on_table_before_source_aligning_method('SAMPLE_EXCEL_WITH_ONE_SHEET', environment.database_schema_name, "sample_excel_with_one_sheet_example_1_raw")