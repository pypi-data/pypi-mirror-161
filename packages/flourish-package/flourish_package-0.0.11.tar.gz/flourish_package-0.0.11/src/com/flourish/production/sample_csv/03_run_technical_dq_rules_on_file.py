...
import importlib
run_dq_rules_module = importlib.import_module("common.ingest.csv.03_run_technical_dq_rules_on_file")
run_dq_rules_method = getattr(run_dq_rules_module, "execute")

run_dq_rules_method('SAMPLE_CSV', environment.database_schema_name, "sample_csv_example_1_raw")