...
def check_if_data_type_of_columns_in_source_file_is_correct(schema, run_details, rule, source_data_frame, source_file_column_to_table_column_mapping_data_frame):
    ...
    try:
        ...
        if(isEverythingAlright):
            ...
            rule_execution_details["status_description"] = 'All columns have the correct datatype as specified in the metadata'
        else:
            rule_execution_details["status_code"] = 'F'
            rule_execution_details["status_description"] = 'Columns having problems with datatype: ' + columnsNotAlright
            result = 'FAILURE'
