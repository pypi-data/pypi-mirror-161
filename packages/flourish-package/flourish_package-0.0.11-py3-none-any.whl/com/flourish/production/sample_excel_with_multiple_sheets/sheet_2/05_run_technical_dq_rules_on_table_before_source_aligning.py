...
run_dq_rules_on_table_before_source_aligning_method('SAMPLE_EXCEL_WITH_MULTIPLE_SHEETS', environment.database_schema_name, "sample_excel_with_multiple_sheets_example_1_sheet_2_raw")