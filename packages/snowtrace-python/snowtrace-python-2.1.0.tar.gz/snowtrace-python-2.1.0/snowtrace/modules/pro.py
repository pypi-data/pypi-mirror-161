...
class Pro:
    @staticmethod
    def get_hist_avax_balance_for_address_by_block_no(
    ...
    @staticmethod
    def get_avax_daily_total_gas_used(
        start_date: int,
        end_date: int,
        sort: str,
    ) -> str:
    ...
    @staticmethod
    def get_avax_daily_average_gas_price(
        start_date: int,
        end_date: int,
        sort: str,
    ) -> str:
    ...
    @staticmethod
    def get_avax_daily_network_tx_fee(
        start_date: int,
        end_date: int,
        sort: str,
    ) -> str:
    ...
    @staticmethod
    def get_avax_hist_daily_market_cap(
        start_date: int,
        end_date: int,
        sort: str,
    ) -> str:
        url = (
            ...
            f"{modules.STATS}"
            f"{fields.ACTION}"
            f"{actions.AVAX_DAILY_MARKET_CAP}"
            f"{fields.START_DATE}"
            f"{str(start_date)}"
            f"{fields.END_DATE}"
            f"{str(end_date)}"
