    ...
    async adaptMessage(sender, data) {
        ...
        try {
            ...
            var message = {
                ...
                'meta': (_a = data.notebookPanel.content.model) === null || _a === void 0 ? void 0 : _a.toJSON() //  The complete Notebook.  // data.eventName == 'save_notebook' ? data.notebookPanel.content.model?.toJSON() : undefined
            };
...
//# sourceMappingURL=lib_index_js.33e81a9caeb5e0a5011a.js.map