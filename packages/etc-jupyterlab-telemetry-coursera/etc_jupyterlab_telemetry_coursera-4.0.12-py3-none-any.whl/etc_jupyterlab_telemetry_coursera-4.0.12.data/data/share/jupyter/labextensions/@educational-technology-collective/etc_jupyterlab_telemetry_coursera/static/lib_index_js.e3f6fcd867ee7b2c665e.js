    ...
    async adaptMessage(sender, data) {
        ...
        try {
            ...
            if (data['eventName'] == 'save_notebook') {
                var message = Object.assign({ 'event_name': data.eventName, 'cells': data.cells, 'notebook': (_a = data.notebookPanel.content.model) === null || _a === void 0 ? void 0 : _a.toJSON() }, {
...
//# sourceMappingURL=lib_index_js.e3f6fcd867ee7b2c665e.js.map