# Windows implementation of uiaction functions.
# MIT license
...
import uiaction
from uiaction import LEFT, MIDDLE, RIGHT

import sys
if sys.platform !=  'win32':
    raise Exception('The uiaction_win module should only be loaded on a Windows system.')


# Fixes the scaling issues where uiaction was reporting the wrong resolution:
try:
...
""" Keyboard key mapping for uiaction:
Documented at http://msdn.microsoft.com/en-us/library/windows/desktop/dd375731(v=vs.85).aspx

The *KB dictionaries in uiaction map a string that can be passed to keyDown(),
keyUp(), or press() into the code used for the OS-specific keyboard function.

They should always be lowercase, and the same keys should be used across all OSes."""
keyboardMapping = dict([(key, None) for key in uiaction.KEY_NAMES])
...
def _keyDown(key):
    ...
    needsShift = uiaction.isShiftCharacter(key)
...
def _moveTo(x, y):
    ...
    # This was a possible solution to issue #314 https://github.com/asweigart/uiaction/issues/314
...
def _mouseDown(x, y, button):
    ...
    try:
        ...
        # TODO: We need to figure out how to prevent these errors, see https://github.com/asweigart/uiaction/issues/60
        pass
...
def _mouseUp(x, y, button):
    ...
    try:
        _sendMouseEvent(EV, x, y)
    except (PermissionError, OSError): # TODO: We need to figure out how to prevent these errors, see https://github.com/asweigart/uiaction/issues/60
        pass
...
def _sendMouseEvent(ev, x, y, dwData=0):
    ...
    # TODO: Too many false positives with this code: See: https://github.com/asweigart/uiaction/issues/108
