...
with open('uiaction/__init__.py', 'r') as fd:
...
setup(
    name='uiaction',
    version=version,
    url='https://github.com/SriBalajiSMVEC/uiaction',
    author='BalajiSanthanam',
    author_email='sribalaji2112@gmail.com',
    description=('uiaction lets Python control the mouse and keyboard, and other GUI automation tasks. For Windows, macOS, and Linux, on Python 3 and 2.'),
