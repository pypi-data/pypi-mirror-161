    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-s3-assets==1.166.1",
        "aws-cdk.aws-ssm==1.166.1",
        "aws-cdk.core==1.166.1",
        "aws-cdk.custom-resources==1.166.1",
        "aws-cdk.lambda-layer-awscli==1.166.1",
        "aws-cdk.lambda-layer-kubectl==1.166.1",
        "aws-cdk.lambda-layer-node-proxy-agent==1.166.1",
