...
def get_project(categories: Optional[Sequence[pulumi.InputType['GetProjectCategoryArgs']]] = None,
    ...
    return AwaitableGetProjectResult(
        account_reference_lists=__ret__.account_reference_lists,
        api_version=__ret__.api_version,
        categories=__ret__.categories,
        default_subnet_reference=__ret__.default_subnet_reference,
        description=__ret__.description,
        environment_reference_lists=__ret__.environment_reference_lists,
        external_network_lists=__ret__.external_network_lists,
        external_user_group_reference_lists=__ret__.external_user_group_reference_lists,
        id=__ret__.id,
        ...
        resource_domains=__ret__.resource_domains,
        state=__ret__.state,
        subnet_reference_lists=__ret__.subnet_reference_lists,
