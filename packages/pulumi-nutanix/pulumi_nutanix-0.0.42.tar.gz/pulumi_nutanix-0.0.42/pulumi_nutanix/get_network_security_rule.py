...
def get_network_security_rule(categories: Optional[Sequence[pulumi.InputType['GetNetworkSecurityRuleCategoryArgs']]] = None,
    ...
    :param str network_security_rule_id: (Required) The ID for the rule you want to retrieve.
           * `name`: - The name for the network_security_rule.
           * `categories`: Categories for the network_security_rule.
           * `project_reference`: The reference to a project.
           * `owner_reference`: The reference to a user.
    ...
    return AwaitableGetNetworkSecurityRuleResult(
        ad_rule_action=__ret__.ad_rule_action,
        ad_rule_inbound_allow_lists=__ret__.ad_rule_inbound_allow_lists,
        ad_rule_outbound_allow_lists=__ret__.ad_rule_outbound_allow_lists,
        ad_rule_target_group_default_internal_policy=__ret__.ad_rule_target_group_default_internal_policy,
        ad_rule_target_group_filter_kind_lists=__ret__.ad_rule_target_group_filter_kind_lists,
        ad_rule_target_group_filter_params=__ret__.ad_rule_target_group_filter_params,
        ad_rule_target_group_filter_type=__ret__.ad_rule_target_group_filter_type,
        ad_rule_target_group_peer_specification_type=__ret__.ad_rule_target_group_peer_specification_type,
        allow_ipv6_traffic=__ret__.allow_ipv6_traffic,
        api_version=__ret__.api_version,
        app_rule_action=__ret__.app_rule_action,
        app_rule_inbound_allow_lists=__ret__.app_rule_inbound_allow_lists,
        app_rule_outbound_allow_lists=__ret__.app_rule_outbound_allow_lists,
        app_rule_target_group_default_internal_policy=__ret__.app_rule_target_group_default_internal_policy,
        app_rule_target_group_filter_kind_lists=__ret__.app_rule_target_group_filter_kind_lists,
        app_rule_target_group_filter_params=__ret__.app_rule_target_group_filter_params,
        app_rule_target_group_filter_type=__ret__.app_rule_target_group_filter_type,
        app_rule_target_group_peer_specification_type=__ret__.app_rule_target_group_peer_specification_type,
        categories=__ret__.categories,
        description=__ret__.description,
        id=__ret__.id,
        is_policy_hitlog_enabled=__ret__.is_policy_hitlog_enabled,
        isolation_rule_action=__ret__.isolation_rule_action,
        isolation_rule_first_entity_filter_kind_lists=__ret__.isolation_rule_first_entity_filter_kind_lists,
        isolation_rule_first_entity_filter_params=__ret__.isolation_rule_first_entity_filter_params,
        isolation_rule_first_entity_filter_type=__ret__.isolation_rule_first_entity_filter_type,
        isolation_rule_second_entity_filter_kind_lists=__ret__.isolation_rule_second_entity_filter_kind_lists,
        isolation_rule_second_entity_filter_params=__ret__.isolation_rule_second_entity_filter_params,
        isolation_rule_second_entity_filter_type=__ret__.isolation_rule_second_entity_filter_type,
        metadata=__ret__.metadata,
        name=__ret__.name,
        network_security_rule_id=__ret__.network_security_rule_id,
        owner_reference=__ret__.owner_reference,
        project_reference=__ret__.project_reference,
        quarantine_rule_action=__ret__.quarantine_rule_action,
        quarantine_rule_inbound_allow_lists=__ret__.quarantine_rule_inbound_allow_lists,
        quarantine_rule_outbound_allow_lists=__ret__.quarantine_rule_outbound_allow_lists,
        quarantine_rule_target_group_default_internal_policy=__ret__.quarantine_rule_target_group_default_internal_policy,
        quarantine_rule_target_group_filter_kind_lists=__ret__.quarantine_rule_target_group_filter_kind_lists,
        quarantine_rule_target_group_filter_params=__ret__.quarantine_rule_target_group_filter_params,
        quarantine_rule_target_group_filter_type=__ret__.quarantine_rule_target_group_filter_type,
        quarantine_rule_target_group_peer_specification_type=__ret__.quarantine_rule_target_group_peer_specification_type)
