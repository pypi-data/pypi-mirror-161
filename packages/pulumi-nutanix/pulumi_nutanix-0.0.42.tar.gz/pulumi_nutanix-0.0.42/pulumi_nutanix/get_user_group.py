...
def get_user_group(categories: Optional[Sequence[pulumi.InputType['GetUserGroupCategoryArgs']]] = None,
    ...
    return AwaitableGetUserGroupResult(
        ...
        directory_service_user_groups=__ret__.directory_service_user_groups,
        ...
        state=__ret__.state,
        user_group_distinguished_name=__ret__.user_group_distinguished_name,
        user_group_id=__ret__.user_group_id,
        user_group_name=__ret__.user_group_name,
        user_group_type=__ret__.user_group_type)
