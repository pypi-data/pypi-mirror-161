...
def get_virtual_machine(boot_device_disk_address: Optional[Mapping[str, str]] = None,
    ...
    return AwaitableGetVirtualMachineResult(
        ...
        availability_zone_reference=__ret__.availability_zone_reference,
        boot_device_disk_address=__ret__.boot_device_disk_address,
        boot_device_mac_address=__ret__.boot_device_mac_address,
        boot_device_order_lists=__ret__.boot_device_order_lists,
        ...
        enable_cpu_passthrough=__ret__.enable_cpu_passthrough,
        enable_script_exec=__ret__.enable_script_exec,
        gpu_lists=__ret__.gpu_lists,
        guest_customization_cloud_init_custom_key_values=__ret__.guest_customization_cloud_init_custom_key_values,
        guest_customization_cloud_init_meta_data=__ret__.guest_customization_cloud_init_meta_data,
        guest_customization_cloud_init_user_data=__ret__.guest_customization_cloud_init_user_data,
        guest_customization_is_overridable=__ret__.guest_customization_is_overridable,
        guest_customization_sysprep=__ret__.guest_customization_sysprep,
        guest_customization_sysprep_custom_key_values=__ret__.guest_customization_sysprep_custom_key_values,
        guest_os_id=__ret__.guest_os_id,
        hardware_clock_timezone=__ret__.hardware_clock_timezone,
        host_reference=__ret__.host_reference,
        hypervisor_type=__ret__.hypervisor_type,
        id=__ret__.id,
        is_vcpu_hard_pinned=__ret__.is_vcpu_hard_pinned,
        machine_type=__ret__.machine_type,
        memory_size_mib=__ret__.memory_size_mib,
        message_lists=__ret__.message_lists,
        metadata=__ret__.metadata,
        name=__ret__.name,
        ngt_credentials=__ret__.ngt_credentials,
        ngt_enabled_capability_lists=__ret__.ngt_enabled_capability_lists,
        nic_lists=__ret__.nic_lists,
        num_sockets=__ret__.num_sockets,
        num_vcpus_per_socket=__ret__.num_vcpus_per_socket,
        num_vnuma_nodes=__ret__.num_vnuma_nodes,
        nutanix_guest_tools=__ret__.nutanix_guest_tools,
        owner_reference=__ret__.owner_reference,
        parent_reference=__ret__.parent_reference,
        power_state=__ret__.power_state,
        power_state_mechanism=__ret__.power_state_mechanism,
        project_reference=__ret__.project_reference,
        serial_port_lists=__ret__.serial_port_lists,
        should_fail_on_script_failure=__ret__.should_fail_on_script_failure,
        state=__ret__.state,
        vga_console_enabled=__ret__.vga_console_enabled,
        vm_id=__ret__.vm_id)
