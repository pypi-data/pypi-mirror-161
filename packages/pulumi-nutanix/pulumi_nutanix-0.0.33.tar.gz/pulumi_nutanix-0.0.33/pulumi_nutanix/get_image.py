...
def get_image(categories: Optional[Sequence[pulumi.InputType['GetImageCategoryArgs']]] = None,
    ...
    return AwaitableGetImageResult(
        ...
        cluster_references=__ret__.cluster_references,
        cluster_uuid=__ret__.cluster_uuid,
        current_cluster_reference_lists=__ret__.current_cluster_reference_lists,
        ...
        retrieval_uri_lists=__ret__.retrieval_uri_lists,
