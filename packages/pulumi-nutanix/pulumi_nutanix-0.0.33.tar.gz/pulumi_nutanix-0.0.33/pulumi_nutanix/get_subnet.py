...
def get_subnet(additional_filters: Optional[Sequence[pulumi.InputType['GetSubnetAdditionalFilterArgs']]] = None,
    ...
    return AwaitableGetSubnetResult(
        additional_filters=__ret__.additional_filters,
        ...
        default_gateway_ip=__ret__.default_gateway_ip,
        description=__ret__.description,
        dhcp_domain_name_server_lists=__ret__.dhcp_domain_name_server_lists,
        dhcp_domain_search_lists=__ret__.dhcp_domain_search_lists,
        dhcp_options=__ret__.dhcp_options,
        dhcp_server_address=__ret__.dhcp_server_address,
        dhcp_server_address_port=__ret__.dhcp_server_address_port,
        enable_nat=__ret__.enable_nat,
        id=__ret__.id,
        ip_config_pool_list_ranges=__ret__.ip_config_pool_list_ranges,
        is_external=__ret__.is_external,
        message_lists=__ret__.message_lists,
        metadata=__ret__.metadata,
        name=__ret__.name,
        network_function_chain_reference=__ret__.network_function_chain_reference,
        ...
        subnet_ip=__ret__.subnet_ip,
        subnet_name=__ret__.subnet_name,
        subnet_type=__ret__.subnet_type,
        vlan_id=__ret__.vlan_id,
        vpc_reference=__ret__.vpc_reference,
