...
def get_karbon_cluster(karbon_cluster_id: Optional[str] = None,
    ...
    return AwaitableGetKarbonClusterResult(
        ...
        etcd_node_pools=__ret__.etcd_node_pools,
        id=__ret__.id,
        karbon_cluster_id=__ret__.karbon_cluster_id,
        karbon_cluster_name=__ret__.karbon_cluster_name,
        kubeapi_server_ipv4_address=__ret__.kubeapi_server_ipv4_address,
        master_node_pools=__ret__.master_node_pools,
        name=__ret__.name,
        status=__ret__.status,
        uuid=__ret__.uuid,
        version=__ret__.version,
        worker_node_pools=__ret__.worker_node_pools)
