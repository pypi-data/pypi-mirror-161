...
def get_foundation_central_imaged_node_details(imaged_node_uuid: Optional[str] = None,
    ...
    return AwaitableGetFoundationCentralImagedNodeDetailsResult(
        aos_version=__ret__.aos_version,
        api_key_uuid=__ret__.api_key_uuid,
        available=__ret__.available,
        block_serial=__ret__.block_serial,
        created_timestamp=__ret__.created_timestamp,
        current_time=__ret__.current_time,
        cvm_gateway=__ret__.cvm_gateway,
        cvm_ip=__ret__.cvm_ip,
        cvm_ipv6=__ret__.cvm_ipv6,
        cvm_netmask=__ret__.cvm_netmask,
        cvm_up=__ret__.cvm_up,
        cvm_uuid=__ret__.cvm_uuid,
        cvm_vlan_id=__ret__.cvm_vlan_id,
        foundation_version=__ret__.foundation_version,
        hardware_attributes=__ret__.hardware_attributes,
        hypervisor_gateway=__ret__.hypervisor_gateway,
        hypervisor_hostname=__ret__.hypervisor_hostname,
        hypervisor_ip=__ret__.hypervisor_ip,
        hypervisor_netmask=__ret__.hypervisor_netmask,
        hypervisor_type=__ret__.hypervisor_type,
        hypervisor_version=__ret__.hypervisor_version,
        id=__ret__.id,
        imaged_cluster_uuid=__ret__.imaged_cluster_uuid,
        imaged_node_uuid=__ret__.imaged_node_uuid,
        ipmi_gateway=__ret__.ipmi_gateway,
        ipmi_ip=__ret__.ipmi_ip,
        ipmi_netmask=__ret__.ipmi_netmask,
        ipv6_interface=__ret__.ipv6_interface,
        latest_hb_ts_lists=__ret__.latest_hb_ts_lists,
        model=__ret__.model,
        node_position=__ret__.node_position,
        node_serial=__ret__.node_serial,
        node_state=__ret__.node_state,
