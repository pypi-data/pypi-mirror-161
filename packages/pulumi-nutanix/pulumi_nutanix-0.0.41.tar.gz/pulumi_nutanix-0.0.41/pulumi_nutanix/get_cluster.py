...
def get_cluster(categories: Optional[Sequence[pulumi.InputType['GetClusterCategoryArgs']]] = None,
    ...
    return AwaitableGetClusterResult(
        analysis_vm_efficiency_map=__ret__.analysis_vm_efficiency_map,
        api_version=__ret__.api_version,
        authorized_public_key_lists=__ret__.authorized_public_key_lists,
        build=__ret__.build,
        ca_certificate_lists=__ret__.ca_certificate_lists,
        categories=__ret__.categories,
        certification_signing_info=__ret__.certification_signing_info,
        client_auth=__ret__.client_auth,
        cluster_arch=__ret__.cluster_arch,
        cluster_id=__ret__.cluster_id,
        domain_server_credentials=__ret__.domain_server_credentials,
        domain_server_name=__ret__.domain_server_name,
        domain_server_nameserver=__ret__.domain_server_nameserver,
        enabled_feature_lists=__ret__.enabled_feature_lists,
        encryption_status=__ret__.encryption_status,
        external_data_services_ip=__ret__.external_data_services_ip,
        external_ip=__ret__.external_ip,
        external_subnet=__ret__.external_subnet,
        gpu_driver_version=__ret__.gpu_driver_version,
        http_proxy_lists=__ret__.http_proxy_lists,
        http_proxy_whitelists=__ret__.http_proxy_whitelists,
        id=__ret__.id,
        internal_subnet=__ret__.internal_subnet,
        is_available=__ret__.is_available,
        management_server_lists=__ret__.management_server_lists,
        masquerading_ip=__ret__.masquerading_ip,
        masquerading_port=__ret__.masquerading_port,
        metadata=__ret__.metadata,
        name=__ret__.name,
        name_server_ip_lists=__ret__.name_server_ip_lists,
        nfs_subnet_whitelists=__ret__.nfs_subnet_whitelists,
        nodes=__ret__.nodes,
        ntp_server_ip_lists=__ret__.ntp_server_ip_lists,
        operation_mode=__ret__.operation_mode,
        owner_reference=__ret__.owner_reference,
        project_reference=__ret__.project_reference,
        service_lists=__ret__.service_lists,
        smtp_server_address=__ret__.smtp_server_address,
        smtp_server_credentials=__ret__.smtp_server_credentials,
        smtp_server_email_address=__ret__.smtp_server_email_address,
        smtp_server_proxy_type_lists=__ret__.smtp_server_proxy_type_lists,
        smtp_server_type=__ret__.smtp_server_type,
        software_map_ncc=__ret__.software_map_ncc,
        software_map_nos=__ret__.software_map_nos,
        ssl_key_expire_datetime=__ret__.ssl_key_expire_datetime,
        ssl_key_name=__ret__.ssl_key_name,
        ssl_key_signing_info=__ret__.ssl_key_signing_info,
        ssl_key_type=__ret__.ssl_key_type,
        state=__ret__.state,
        supported_information_verbosity=__ret__.supported_information_verbosity,
