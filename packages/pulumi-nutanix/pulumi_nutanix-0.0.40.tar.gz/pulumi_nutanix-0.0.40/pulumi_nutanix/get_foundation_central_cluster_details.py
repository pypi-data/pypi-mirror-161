...
def get_foundation_central_cluster_details(cluster_external_ip: Optional[str] = None,
    ...
    return AwaitableGetFoundationCentralClusterDetailsResult(
        ...
        cluster_external_ip=__ret__.cluster_external_ip,
        cluster_name=__ret__.cluster_name,
        cluster_size=__ret__.cluster_size,
        cluster_status=__ret__.cluster_status,
        common_network_settings=__ret__.common_network_settings,
        created_timestamp=__ret__.created_timestamp,
        current_time=__ret__.current_time,
        destroyed=__ret__.destroyed,
        foundation_init_configs=__ret__.foundation_init_configs,
        foundation_init_node_uuid=__ret__.foundation_init_node_uuid,
        id=__ret__.id,
        imaged_cluster_uuid=__ret__.imaged_cluster_uuid,
        imaged_node_uuid_lists=__ret__.imaged_node_uuid_lists,
        redundancy_factor=__ret__.redundancy_factor,
        storage_node_count=__ret__.storage_node_count,
        workflow_type=__ret__.workflow_type)
