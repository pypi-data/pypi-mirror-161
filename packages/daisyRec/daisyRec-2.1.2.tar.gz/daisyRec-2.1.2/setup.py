...
setup(
    ...
    version='v2.1.2',  # Ideally should be same as your GitHub release tag varsion
    ...
    download_url='https://github.com/AmazingDD/daisyRec/archive/refs/tags/v2.1.2.tar.gz',
