...
with open("tegram/__init__.py", encoding="utf-8") as f:
...
setup(
    ...
    url="https://github.com/tegram",
    download_url="https://github.com/tegram/tegram/releases/latest",
    author="Dan",
    author_email="dan@tegram.org",
    license="LGPLv3",
    classifiers=[
    ...
    project_urls={
        "Tracker": "https://github.com/tegram/tegram/issues",
        "Community": "https://t.me/tegram",
        "Source": "https://github.com/tegram/tegram",
        "Documentation": "https://docs.tegram.org",
    },
    python_requires="~=3.7",
    package_data={
        "tegram": ["py.typed"],
