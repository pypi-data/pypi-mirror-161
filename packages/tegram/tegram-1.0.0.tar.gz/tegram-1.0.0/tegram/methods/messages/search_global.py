...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~tegram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~tegram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~tegram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "tegram". Get the first 50 results
                async for message in app.search_global("tegram", limit=50):
                    print(message.text)
