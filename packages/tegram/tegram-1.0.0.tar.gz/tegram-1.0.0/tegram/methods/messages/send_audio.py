...
import tegram
from tegram import StopTransmission, enums
from tegram import raw
from tegram import types
from tegram import utils
from tegram.errors import FilePartMissing
from tegram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~tegram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~tegram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~tegram.Client.stop_transmission`, None is returned.
