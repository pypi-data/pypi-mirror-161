...
from tegram.errors import AuthBytesInvalid
from tegram.session import Session
from tegram.session.auth import Auth


async def get_session(client: "tegram.Client", dc_id: int):
