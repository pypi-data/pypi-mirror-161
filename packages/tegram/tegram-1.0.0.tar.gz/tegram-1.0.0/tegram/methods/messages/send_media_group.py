...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~tegram.types.InputMediaPhoto`, :obj:`~tegram.types.InputMediaVideo`, :obj:`~tegram.types.InputMediaAudio` and :obj:`~tegram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~tegram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from tegram.types import InputMediaPhoto, InputMediaVideo
