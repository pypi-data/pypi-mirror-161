...
from tegram.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~tegram.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <tegram.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("tegrambot")
                print(results)
        """
