...
class SendInlineBotResult:
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~tegram.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~tegram.types.Message`: On success, the sent inline result message is returned.
