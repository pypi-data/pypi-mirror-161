...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <tegram.api.functions>` package and may accept compound
        data types from :obj:`types <tegram.api.types>` as well as bare types such as ``int``, ``str``, etc...
