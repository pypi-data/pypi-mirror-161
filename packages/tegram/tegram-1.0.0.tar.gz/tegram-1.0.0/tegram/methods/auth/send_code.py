...
from tegram.errors import PhoneMigrate, NetworkMigrate
from tegram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~tegram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
