...
async def compose(
    clients: List["tegram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``tegram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~tegram.Client.run`.

    Parameters:
        clients (List of :obj:`~tegram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from tegram import Client, compose
