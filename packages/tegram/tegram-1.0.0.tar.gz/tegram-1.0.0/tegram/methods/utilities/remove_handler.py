...
import tegram
from tegram.handlers import DisconnectHandler
...
class RemoveHandler:
    def remove_handler(
        ...
        :meth:`~tegram.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from tegram.handlers import MessageHandler
