...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~tegram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, tegram.Client):
                self.add_handler(tegram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        tegram.handlers.ChatJoinRequestHandler(func, self),
