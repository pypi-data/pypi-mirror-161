...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~tegram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, tegram.Client):
                self.add_handler(tegram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        tegram.handlers.ChatMemberUpdatedHandler(func, self),
