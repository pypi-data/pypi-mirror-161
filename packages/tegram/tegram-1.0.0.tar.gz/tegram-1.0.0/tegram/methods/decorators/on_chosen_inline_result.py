...
import tegram
from tegram.filters import Filter
...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        This does the same thing as :meth:`~tegram.Client.add_handler` using the
        :obj:`~tegram.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~tegram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, tegram.Client):
                self.add_handler(tegram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        tegram.handlers.ChosenInlineResultHandler(func, self),
