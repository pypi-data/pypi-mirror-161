...
import tegram
from tegram import raw, types, utils, enums
...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~tegram.enums.ChatMemberStatus`):
            The member's status in the chat.

        user (:obj:`~tegram.types.User`, *optional*):
        ...
        invited_by (:obj:`~tegram.types.User`, *optional*):
