...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~tegram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~tegram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~tegram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~tegram.types.CallbackGame`, *optional*):
