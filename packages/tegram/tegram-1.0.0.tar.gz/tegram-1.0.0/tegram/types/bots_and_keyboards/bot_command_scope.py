...
class BotCommandScope(Object):
    ...
    - :obj:`~tegram.types.BotCommandScopeDefault`
    - :obj:`~tegram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~tegram.types.BotCommandScopeAllGroupChats`
    - :obj:`~tegram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~tegram.types.BotCommandScopeChat`
    - :obj:`~tegram.types.BotCommandScopeChatAdministrators`
    - :obj:`~tegram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "tegram.Client") -> "raw.base.BotCommandScope":
