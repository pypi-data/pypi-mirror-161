...
class InputMedia(Object):
    ...
    - :obj:`~tegram.types.InputMediaAnimation`
    - :obj:`~tegram.types.InputMediaDocument`
    - :obj:`~tegram.types.InputMediaAudio`
    - :obj:`~tegram.types.InputMediaPhoto`
    - :obj:`~tegram.types.InputMediaVideo`
    """
