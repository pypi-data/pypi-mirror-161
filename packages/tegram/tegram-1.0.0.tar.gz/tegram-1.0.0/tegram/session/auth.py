...
from tegram.crypto import aes, rsa, prime
from tegram.errors import SecurityCheckMismatch
from tegram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "tegram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
