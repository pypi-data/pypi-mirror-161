...
from tegram.types import Message
from .handler import Handler


class DeletedMessagesHandler(Handler):
    """The deleted messages handler class. Used to handle deleted messages coming from any chat
    (private, group, channel). It is intended to be used with :meth:`~tegram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~tegram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~tegram.types.Message`):
    ...
    async def check(self, client: "tegram.Client", messages: List[Message]):
