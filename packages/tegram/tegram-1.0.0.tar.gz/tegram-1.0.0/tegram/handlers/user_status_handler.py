...
class UserStatusHandler(Handler):
    ...
    It is intended to be used with :meth:`~tegram.Client.add_handler`.

    For a nicer way to register this handler, have a look at the :meth:`~tegram.Client.on_user_status` decorator.
