...
from tegram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "tegram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~tegram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~tegram.handlers.MessageHandler` the *update* argument will be a :obj:`~tegram.types.Message`; in a :obj:`~tegram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~tegram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~tegram.filters.command` or :meth:`~tegram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~tegram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~tegram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~tegram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~tegram.types.Message`.
    ...
    async def func(flt, client: tegram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~tegram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~tegram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~tegram.types.InlineQuery`: The filter will match ``query``.
