...
setup(name='search_buddy_linux',
      version='1.0.3',
      description='A tool to simplify initial literature searches',
      #long_description=long_description,
      url='https://github.com/soapGame34/lib-search-buddy-linux',
      author='Alexander J. Calder',
      author_email='alexcalder91@gmail.com',
      license='MIT',
      entry_points = { 'console_scripts' : ['search_buddy = search_buddy_linux.search_buddy_linux.command_line:main']},
