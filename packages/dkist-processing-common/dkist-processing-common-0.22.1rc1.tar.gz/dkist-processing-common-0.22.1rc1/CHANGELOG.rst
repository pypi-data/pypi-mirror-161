...
- Updating minimum version of dkist-processing-core to support airflow upgrade
- Moving to globus-sdk >= 3.10.1 as airflow is now compatible with globus-sdk > 3.0
