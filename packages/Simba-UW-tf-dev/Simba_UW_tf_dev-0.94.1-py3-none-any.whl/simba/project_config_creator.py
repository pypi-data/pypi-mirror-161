...
class ProjectConfigCreator(object):
    def __init__(self,
                 ...
                 pose_estimation_bp_cnt: int = None,
    ...
    def create_configparser_config(self):
        ...
        self.config['create ensemble settings']['animal_1_bp'] = str(self.pose_estimation_bp_cnt)
        ...
        config_path = os.path.join(self.project_folder, 'project_config.ini')
