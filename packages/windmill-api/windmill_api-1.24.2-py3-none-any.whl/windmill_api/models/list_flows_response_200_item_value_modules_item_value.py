...
from ..models.list_flows_response_200_item_value_modules_item_value_iterator import (
...
class ListFlowsResponse200ItemValueModulesItemValue:
    ...
    iterator: Union[Unset, ListFlowsResponse200ItemValueModulesItemValueIterator] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_iterator, Unset):
            iterator = ListFlowsResponse200ItemValueModulesItemValueIterator.from_dict(_iterator)
