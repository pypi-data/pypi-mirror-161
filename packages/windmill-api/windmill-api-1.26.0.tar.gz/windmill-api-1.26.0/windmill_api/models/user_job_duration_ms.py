...
T = TypeVar("T", bound="UserJobDurationMs")


@attr.s(auto_attribs=True)
class UserJobDurationMs:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_job_duration_ms = cls(
            duration_ms=duration_ms,
            jobs=jobs,
            flows=flows,
        )

        user_job_duration_ms.additional_properties = d
        return user_job_duration_ms
