...
from ..models.open_flow_value_modules_item_value import OpenFlowValueModulesItemValue
...
class OpenFlowValueModulesItem:
    ...
    value: OpenFlowValueModulesItemValue
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = OpenFlowValueModulesItemValue.from_dict(d.pop("value"))
