...
from ..models.get_hub_flow_by_id_response_200_flow_value_failure_module_value import (
...
class GetHubFlowByIdResponse200FlowValueFailureModule:
    ...
    value: GetHubFlowByIdResponse200FlowValueFailureModuleValue
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = GetHubFlowByIdResponse200FlowValueFailureModuleValue.from_dict(d.pop("value"))
