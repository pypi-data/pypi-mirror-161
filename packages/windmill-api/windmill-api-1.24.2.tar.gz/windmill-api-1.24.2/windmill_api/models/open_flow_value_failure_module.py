...
from ..models.open_flow_value_failure_module_value import OpenFlowValueFailureModuleValue
...
class OpenFlowValueFailureModule:
    ...
    value: OpenFlowValueFailureModuleValue
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = OpenFlowValueFailureModuleValue.from_dict(d.pop("value"))
