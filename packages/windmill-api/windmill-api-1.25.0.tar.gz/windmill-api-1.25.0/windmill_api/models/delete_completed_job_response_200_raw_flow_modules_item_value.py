...
from ..models.delete_completed_job_response_200_raw_flow_modules_item_value_iterator import (
...
class DeleteCompletedJobResponse200RawFlowModulesItemValue:
    ...
    iterator: Union[Unset, DeleteCompletedJobResponse200RawFlowModulesItemValueIterator] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_iterator, Unset):
            iterator = DeleteCompletedJobResponse200RawFlowModulesItemValueIterator.from_dict(_iterator)
