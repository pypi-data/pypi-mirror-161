...
from ..models.get_hub_flow_by_id_response_200_flow_value_modules_item_value import (
...
class GetHubFlowByIdResponse200FlowValueModulesItem:
    ...
    value: GetHubFlowByIdResponse200FlowValueModulesItemValue
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = GetHubFlowByIdResponse200FlowValueModulesItemValue.from_dict(d.pop("value"))
