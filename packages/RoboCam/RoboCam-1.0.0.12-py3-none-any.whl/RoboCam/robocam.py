...
class RoboCam():
    def __init__(self):
        self.__streamFlag = False
        self.__streamInitFlag = False
    ...
    def CameraStream(self):
        if( self.__streamFlag == True ):
            print("The camera is already working.")
            return
        self.__streamFlag = True
