...
def make_rules():
	...
	print('installing rules for accessing eyesjr hardware...', sys.argv)
	system = platform.system()
	if os.getuid() != 0 and system in ['Linux', 'FreeBSD']:
		raise OSError(
				'You must have root privileges to install udev/devd rules! sudo pip3 install eyesjr')
	if system == 'Linux':
...
setuptools.setup(
    ...
    entry_points={
    'console_scripts': [
        'eyesjr=eyesjrGUI.main:run',
    		],
	},
	cmdclass = {'install':InstallCommand},
    keywords = 'expeyesjr data-acquisition lab-at-home oscilloscope waveform-generator sensors physics',
    python_requires='>=3',
