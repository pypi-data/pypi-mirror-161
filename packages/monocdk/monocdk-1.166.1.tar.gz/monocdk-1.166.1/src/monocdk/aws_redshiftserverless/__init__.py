...
class CfnWorkgroup(
    ...
    def __init__(
        ...
        *,
        ...
        config_parameters: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnWorkgroup.ConfigParameterProperty", _IResolvable_a771d0ef]]]] = None,
