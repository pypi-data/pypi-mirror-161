...
class HardwareType(object):
    ...
    allowable_values = [K80, V100, T4, CPU, EPYC, JETSON_XAVIER, JETSON_NANO, JETSON_XAVIER_AGX, JETSON_ORIN, CASCADE_LAKE, SKYLAKE, BROADWELL, INTEL_NUC_TIGER_LAKE]  # noqa: E501
