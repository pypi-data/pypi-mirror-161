...
class HardwareType(object):
    ...
    allowable_values = [K80, V100, T4, A100_80GB_GCP, A100_40GB_GCP, CPU, EPYC, JETSON_XAVIER, JETSON_NANO, JETSON_XAVIER_AGX, JETSON_ORIN, CASCADE_LAKE, SKYLAKE, BROADWELL, INTEL_NUC_TIGER_LAKE]  # noqa: E501
