...
class EmptyCommandQueueHandler(QuantConnect.Commands.BaseCommandHandler):
    """
    Provides an implementation of ICommandHandler that never
...
class FileCommandQueueHandler(QuantConnect.Commands.BaseCommandHandler):
    """
    ...
    def __init__(self) -> None:
        """
        Initializes a new instance of the FileCommandQueueHandler class
