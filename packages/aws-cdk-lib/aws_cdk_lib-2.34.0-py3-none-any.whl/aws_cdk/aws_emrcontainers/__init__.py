...
class CfnVirtualCluster(
    ...
    class ContainerInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ContainerInfoProperty.__init__)
    ...
    class ContainerProviderProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ContainerProviderProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    class EksInfoProperty:
        def __init__(self, *, namespace: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EksInfoProperty.__init__)
