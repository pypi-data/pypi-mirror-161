...
class CfnApplication(
    ...
    class AlarmMetricProperty:
        def __init__(self, *, alarm_metric_name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AlarmMetricProperty.__init__)
    ...
    class ComponentMonitoringSettingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentMonitoringSettingProperty.__init__)
    ...
    class ConfigurationDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigurationDetailsProperty.__init__)
    ...
    class CustomComponentProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomComponentProperty.__init__)
                check_type(argname="argument component_name", value=component_name, expected_type=type_hints["component_name"])
    ...
    class HAClusterPrometheusExporterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HAClusterPrometheusExporterProperty.__init__)
    ...
    class HANAPrometheusExporterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HANAPrometheusExporterProperty.__init__)
    ...
    class JMXPrometheusExporterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(JMXPrometheusExporterProperty.__init__)
    ...
    class LogPatternProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LogPatternProperty.__init__)
    ...
    class LogPatternSetProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LogPatternSetProperty.__init__)
    ...
    class LogProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LogProperty.__init__)
    ...
    class SubComponentConfigurationDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SubComponentConfigurationDetailsProperty.__init__)
                check_type(argname="argument alarm_metrics", value=alarm_metrics, expected_type=type_hints["alarm_metrics"])
                check_type(argname="argument logs", value=logs, expected_type=type_hints["logs"])
                check_type(argname="argument windows_events", value=windows_events, expected_type=type_hints["windows_events"])
            self._values: typing.Dict[str, typing.Any] = {}
    ...
    class SubComponentTypeConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SubComponentTypeConfigurationProperty.__init__)
    ...
    class WindowsEventProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(WindowsEventProperty.__init__)
