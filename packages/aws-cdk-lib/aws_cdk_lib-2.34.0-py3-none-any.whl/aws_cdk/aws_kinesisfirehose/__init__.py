...
class CfnDeliveryStream(
    ...
    class AmazonopensearchserviceBufferingHintsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AmazonopensearchserviceBufferingHintsProperty.__init__)
    ...
    class AmazonopensearchserviceDestinationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AmazonopensearchserviceDestinationConfigurationProperty.__init__)
    ...
    class AmazonopensearchserviceRetryOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AmazonopensearchserviceRetryOptionsProperty.__init__)
    ...
    class BufferingHintsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BufferingHintsProperty.__init__)
                check_type(argname="argument interval_in_seconds", value=interval_in_seconds, expected_type=type_hints["interval_in_seconds"])
                check_type(argname="argument size_in_m_bs", value=size_in_m_bs, expected_type=type_hints["size_in_m_bs"])
            self._values: typing.Dict[str, typing.Any] = {}
            if interval_in_seconds is not None:
    ...
    class CloudWatchLoggingOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CloudWatchLoggingOptionsProperty.__init__)
    ...
    class CopyCommandProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CopyCommandProperty.__init__)
    ...
    class DataFormatConversionConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DataFormatConversionConfigurationProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    class DeliveryStreamEncryptionConfigurationInputProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DeliveryStreamEncryptionConfigurationInputProperty.__init__)
    ...
    class DeserializerProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DeserializerProperty.__init__)
    ...
    class DynamicPartitioningConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DynamicPartitioningConfigurationProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
                check_type(argname="argument retry_options", value=retry_options, expected_type=type_hints["retry_options"])
            self._values: typing.Dict[str, typing.Any] = {}
            if enabled is not None:
    ...
    class ElasticsearchBufferingHintsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ElasticsearchBufferingHintsProperty.__init__)
                check_type(argname="argument interval_in_seconds", value=interval_in_seconds, expected_type=type_hints["interval_in_seconds"])
                check_type(argname="argument size_in_m_bs", value=size_in_m_bs, expected_type=type_hints["size_in_m_bs"])
            self._values: typing.Dict[str, typing.Any] = {}
            if interval_in_seconds is not None:
    ...
    class ElasticsearchDestinationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ElasticsearchDestinationConfigurationProperty.__init__)
                check_type(argname="argument index_name", value=index_name, expected_type=type_hints["index_name"])
                check_type(argname="argument role_arn", value=role_arn, expected_type=type_hints["role_arn"])
                check_type(argname="argument s3_configuration", value=s3_configuration, expected_type=type_hints["s3_configuration"])
                check_type(argname="argument buffering_hints", value=buffering_hints, expected_type=type_hints["buffering_hints"])
    ...
    class ElasticsearchRetryOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ElasticsearchRetryOptionsProperty.__init__)
                check_type(argname="argument duration_in_seconds", value=duration_in_seconds, expected_type=type_hints["duration_in_seconds"])
            self._values: typing.Dict[str, typing.Any] = {}
            if duration_in_seconds is not None:
                self._values["duration_in_seconds"] = duration_in_seconds
    ...
    class ExtendedS3DestinationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ExtendedS3DestinationConfigurationProperty.__init__)
    ...
    class HiveJsonSerDeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HiveJsonSerDeProperty.__init__)
    ...
    class HttpEndpointCommonAttributeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HttpEndpointCommonAttributeProperty.__init__)
    ...
    class HttpEndpointConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HttpEndpointConfigurationProperty.__init__)
    ...
    class HttpEndpointDestinationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HttpEndpointDestinationConfigurationProperty.__init__)
    ...
    class HttpEndpointRequestConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HttpEndpointRequestConfigurationProperty.__init__)
    ...
    class InputFormatConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(InputFormatConfigurationProperty.__init__)
    ...
    class KMSEncryptionConfigProperty:
        def __init__(self, *, awskms_key_arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(KMSEncryptionConfigProperty.__init__)
    ...
    class KinesisStreamSourceConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(KinesisStreamSourceConfigurationProperty.__init__)
    ...
    class OpenXJsonSerDeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(OpenXJsonSerDeProperty.__init__)
    ...
    class OrcSerDeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(OrcSerDeProperty.__init__)
    ...
    class OutputFormatConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(OutputFormatConfigurationProperty.__init__)
    ...
    class ParquetSerDeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ParquetSerDeProperty.__init__)
                check_type(argname="argument block_size_bytes", value=block_size_bytes, expected_type=type_hints["block_size_bytes"])
                check_type(argname="argument compression", value=compression, expected_type=type_hints["compression"])
    ...
    class ProcessingConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProcessingConfigurationProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    class ProcessorParameterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProcessorParameterProperty.__init__)
    ...
    class ProcessorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProcessorProperty.__init__)
    ...
    class RedshiftDestinationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RedshiftDestinationConfigurationProperty.__init__)
    ...
    class RedshiftRetryOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RedshiftRetryOptionsProperty.__init__)
                check_type(argname="argument duration_in_seconds", value=duration_in_seconds, expected_type=type_hints["duration_in_seconds"])
            self._values: typing.Dict[str, typing.Any] = {}
            if duration_in_seconds is not None:
                self._values["duration_in_seconds"] = duration_in_seconds
    ...
    class RetryOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RetryOptionsProperty.__init__)
                check_type(argname="argument duration_in_seconds", value=duration_in_seconds, expected_type=type_hints["duration_in_seconds"])
            self._values: typing.Dict[str, typing.Any] = {}
            if duration_in_seconds is not None:
                self._values["duration_in_seconds"] = duration_in_seconds
    ...
    class SchemaConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SchemaConfigurationProperty.__init__)
    ...
    class SerializerProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SerializerProperty.__init__)
    ...
    class SplunkDestinationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SplunkDestinationConfigurationProperty.__init__)
    ...
    class SplunkRetryOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SplunkRetryOptionsProperty.__init__)
                check_type(argname="argument duration_in_seconds", value=duration_in_seconds, expected_type=type_hints["duration_in_seconds"])
            self._values: typing.Dict[str, typing.Any] = {}
            if duration_in_seconds is not None:
                self._values["duration_in_seconds"] = duration_in_seconds
