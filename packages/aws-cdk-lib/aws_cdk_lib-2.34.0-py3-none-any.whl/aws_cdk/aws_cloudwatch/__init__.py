    ...
    class MetricDataQueryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricDataQueryProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    class MetricStatProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricStatProperty.__init__)
...
class CfnAnomalyDetector(
    ...
    class MetricMathAnomalyDetectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricMathAnomalyDetectorProperty.__init__)
    ...
    class RangeProperty:
        def __init__(self, *, end_time: builtins.str, start_time: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RangeProperty.__init__)
    ...
    class SingleMetricAnomalyDetectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SingleMetricAnomalyDetectorProperty.__init__)
                check_type(argname="argument dimensions", value=dimensions, expected_type=type_hints["dimensions"])
                check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
                check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
                check_type(argname="argument stat", value=stat, expected_type=type_hints["stat"])
...
class CfnMetricStream(
    ...
    class MetricStreamFilterProperty:
        def __init__(self, *, namespace: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricStreamFilterProperty.__init__)
                check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
            self._values: typing.Dict[str, typing.Any] = {
                "namespace": namespace,
            }
    ...
    class MetricStreamStatisticsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricStreamStatisticsConfigurationProperty.__init__)
    ...
    class MetricStreamStatisticsMetricProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricStreamStatisticsMetricProperty.__init__)
                check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
                check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
            self._values: typing.Dict[str, typing.Any] = {
                "metric_name": metric_name,
