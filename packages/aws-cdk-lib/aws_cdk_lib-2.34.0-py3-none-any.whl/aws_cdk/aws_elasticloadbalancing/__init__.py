...
class CfnLoadBalancer(
    ...
    class AccessLoggingPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AccessLoggingPolicyProperty.__init__)
    ...
    class AppCookieStickinessPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AppCookieStickinessPolicyProperty.__init__)
    ...
    class ConnectionDrainingPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConnectionDrainingPolicyProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    class ConnectionSettingsProperty:
        def __init__(self, *, idle_timeout: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConnectionSettingsProperty.__init__)
    ...
    class HealthCheckProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HealthCheckProperty.__init__)
    ...
    class LBCookieStickinessPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LBCookieStickinessPolicyProperty.__init__)
    ...
    class ListenersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ListenersProperty.__init__)
    ...
    class PoliciesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PoliciesProperty.__init__)
