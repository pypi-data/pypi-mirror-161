...
class CfnInstanceAccessControlAttributeConfiguration(
    ...
    class AccessControlAttributeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AccessControlAttributeProperty.__init__)
    ...
    class AccessControlAttributeValueProperty:
        def __init__(self, *, source: typing.Sequence[builtins.str]) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AccessControlAttributeValueProperty.__init__)
...
class CfnPermissionSet(
    ...
    def __init__(
        ...
        *,
        instance_arn: builtins.str,
        name: builtins.str,
        customer_managed_policy_references: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union["CfnPermissionSet.CustomerManagedPolicyReferenceProperty", _IResolvable_da3f097b]]]] = None,
        description: typing.Optional[builtins.str] = None,
        inline_policy: typing.Any = None,
        managed_policies: typing.Optional[typing.Sequence[builtins.str]] = None,
        permissions_boundary: typing.Optional[typing.Union["CfnPermissionSet.PermissionsBoundaryProperty", _IResolvable_da3f097b]] = None,
    ...
    class CustomerManagedPolicyReferenceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomerManagedPolicyReferenceProperty.__init__)
    ...
    class PermissionsBoundaryProperty:
        def __init__(
            self,
            *,
            customer_managed_policy_reference: typing.Optional[typing.Union["CfnPermissionSet.CustomerManagedPolicyReferenceProperty", _IResolvable_da3f097b]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PermissionsBoundaryProperty.__init__)
