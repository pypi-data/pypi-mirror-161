...
class CfnBudget(
    ...
    class BudgetDataProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BudgetDataProperty.__init__)
    ...
    class CostTypesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CostTypesProperty.__init__)
    ...
    class NotificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NotificationProperty.__init__)
    ...
    class NotificationWithSubscribersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NotificationWithSubscribersProperty.__init__)
    ...
    class SpendProperty:
        def __init__(self, *, amount: jsii.Number, unit: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SpendProperty.__init__)
    ...
    class SubscriberProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SubscriberProperty.__init__)
    ...
    class TimePeriodProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TimePeriodProperty.__init__)
...
class CfnBudgetsAction(
    ...
    class ActionThresholdProperty:
        def __init__(self, *, type: builtins.str, value: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ActionThresholdProperty.__init__)
    ...
    class DefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DefinitionProperty.__init__)
    ...
    class IamActionDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(IamActionDefinitionProperty.__init__)
    ...
    class ScpActionDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ScpActionDefinitionProperty.__init__)
    ...
    class SsmActionDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SsmActionDefinitionProperty.__init__)
