    ...
    class AccessPointTagProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AccessPointTagProperty.__init__)
    ...
    class CreationInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CreationInfoProperty.__init__)
                check_type(argname="argument owner_gid", value=owner_gid, expected_type=type_hints["owner_gid"])
                check_type(argname="argument owner_uid", value=owner_uid, expected_type=type_hints["owner_uid"])
                check_type(argname="argument permissions", value=permissions, expected_type=type_hints["permissions"])
            self._values: typing.Dict[str, typing.Any] = {
    ...
    class PosixUserProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PosixUserProperty.__init__)
    ...
    class RootDirectoryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RootDirectoryProperty.__init__)
...
class CfnFileSystem(
    ...
    class BackupPolicyProperty:
        def __init__(self, *, status: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BackupPolicyProperty.__init__)
    ...
    class ElasticFileSystemTagProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ElasticFileSystemTagProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {
                "key": key,
