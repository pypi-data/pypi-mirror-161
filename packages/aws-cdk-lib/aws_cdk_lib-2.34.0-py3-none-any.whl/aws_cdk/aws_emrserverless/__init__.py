...
class CfnApplication(
    ...
    def __init__(
        ...
        *,
        ...
        type: builtins.str,
        auto_start_configuration: typing.Optional[typing.Union["CfnApplication.AutoStartConfigurationProperty", _IResolvable_da3f097b]] = None,
        auto_stop_configuration: typing.Optional[typing.Union["CfnApplication.AutoStopConfigurationProperty", _IResolvable_da3f097b]] = None,
        initial_capacity: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union["CfnApplication.InitialCapacityConfigKeyValuePairProperty", _IResolvable_da3f097b]]]] = None,
        maximum_capacity: typing.Optional[typing.Union["CfnApplication.MaximumAllowedResourcesProperty", _IResolvable_da3f097b]] = None,
        name: typing.Optional[builtins.str] = None,
        network_configuration: typing.Optional[typing.Union["CfnApplication.NetworkConfigurationProperty", _IResolvable_da3f097b]] = None,
    ...
    class AutoStartConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AutoStartConfigurationProperty.__init__)
    ...
    class AutoStopConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AutoStopConfigurationProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    class InitialCapacityConfigKeyValuePairProperty:
        def __init__(
            ...
            *,
            key: builtins.str,
            value: typing.Union["CfnApplication.InitialCapacityConfigProperty", _IResolvable_da3f097b],
        ) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(InitialCapacityConfigKeyValuePairProperty.__init__)
    ...
    class InitialCapacityConfigProperty:
        def __init__(
            self,
            *,
            worker_configuration: typing.Union["CfnApplication.WorkerConfigurationProperty", _IResolvable_da3f097b],
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(InitialCapacityConfigProperty.__init__)
    ...
    class MaximumAllowedResourcesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MaximumAllowedResourcesProperty.__init__)
    ...
    class WorkerConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(WorkerConfigurationProperty.__init__)
                check_type(argname="argument cpu", value=cpu, expected_type=type_hints["cpu"])
                check_type(argname="argument memory", value=memory, expected_type=type_hints["memory"])
                check_type(argname="argument disk", value=disk, expected_type=type_hints["disk"])
            self._values: typing.Dict[str, typing.Any] = {
