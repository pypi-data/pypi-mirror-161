    ...
    class ApplicationResourceLifecycleConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ApplicationResourceLifecycleConfigProperty.__init__)
    ...
    class ApplicationVersionLifecycleConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ApplicationVersionLifecycleConfigProperty.__init__)
    ...
    class MaxAgeRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MaxAgeRuleProperty.__init__)
    ...
    class MaxCountRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MaxCountRuleProperty.__init__)
                check_type(argname="argument delete_source_from_s3", value=delete_source_from_s3, expected_type=type_hints["delete_source_from_s3"])
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
...
class CfnApplicationVersion(
    ...
    class SourceBundleProperty:
        def __init__(self, *, s3_bucket: builtins.str, s3_key: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SourceBundleProperty.__init__)
    ...
    class ConfigurationOptionSettingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigurationOptionSettingProperty.__init__)
    ...
    class OptionSettingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(OptionSettingProperty.__init__)
                check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
                check_type(argname="argument option_name", value=option_name, expected_type=type_hints["option_name"])
                check_type(argname="argument resource_name", value=resource_name, expected_type=type_hints["resource_name"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class TierProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TierProperty.__init__)
