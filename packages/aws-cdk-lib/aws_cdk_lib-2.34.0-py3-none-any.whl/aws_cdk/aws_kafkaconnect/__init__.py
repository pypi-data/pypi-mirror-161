...
class CfnConnector(
    ...
    class ApacheKafkaClusterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ApacheKafkaClusterProperty.__init__)
    ...
    class AutoScalingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AutoScalingProperty.__init__)
    ...
    class CapacityProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CapacityProperty.__init__)
    ...
    class CloudWatchLogsLogDeliveryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CloudWatchLogsLogDeliveryProperty.__init__)
    ...
    class CustomPluginProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomPluginProperty.__init__)
    ...
    class FirehoseLogDeliveryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FirehoseLogDeliveryProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    class KafkaClusterClientAuthenticationProperty:
        def __init__(self, *, authentication_type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(KafkaClusterClientAuthenticationProperty.__init__)
    ...
    class KafkaClusterEncryptionInTransitProperty:
        def __init__(self, *, encryption_type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(KafkaClusterEncryptionInTransitProperty.__init__)
    ...
    class KafkaClusterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(KafkaClusterProperty.__init__)
    ...
    class LogDeliveryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LogDeliveryProperty.__init__)
    ...
    class PluginProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PluginProperty.__init__)
    ...
    class ProvisionedCapacityProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProvisionedCapacityProperty.__init__)
    ...
    class S3LogDeliveryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(S3LogDeliveryProperty.__init__)
                check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
    ...
    class ScaleInPolicyProperty:
        def __init__(self, *, cpu_utilization_percentage: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ScaleInPolicyProperty.__init__)
    ...
    class ScaleOutPolicyProperty:
        def __init__(self, *, cpu_utilization_percentage: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ScaleOutPolicyProperty.__init__)
                check_type(argname="argument cpu_utilization_percentage", value=cpu_utilization_percentage, expected_type=type_hints["cpu_utilization_percentage"])
            self._values: typing.Dict[str, typing.Any] = {
                "cpu_utilization_percentage": cpu_utilization_percentage,
            }
    ...
    class VpcProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(VpcProperty.__init__)
    ...
    class WorkerLogDeliveryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(WorkerLogDeliveryProperty.__init__)
