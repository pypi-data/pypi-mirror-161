...
class CfnLicense(
    ...
    class BorrowConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BorrowConfigurationProperty.__init__)
    ...
    class ConsumptionConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConsumptionConfigurationProperty.__init__)
    ...
    class EntitlementProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EntitlementProperty.__init__)
    ...
    class IssuerDataProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(IssuerDataProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    class ProvisionalConfigurationProperty:
        def __init__(self, *, max_time_to_live_in_minutes: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProvisionalConfigurationProperty.__init__)
                check_type(argname="argument max_time_to_live_in_minutes", value=max_time_to_live_in_minutes, expected_type=type_hints["max_time_to_live_in_minutes"])
            self._values: typing.Dict[str, typing.Any] = {
                "max_time_to_live_in_minutes": max_time_to_live_in_minutes,
            }
    ...
    class ValidityDateFormatProperty:
        def __init__(self, *, begin: builtins.str, end: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ValidityDateFormatProperty.__init__)
