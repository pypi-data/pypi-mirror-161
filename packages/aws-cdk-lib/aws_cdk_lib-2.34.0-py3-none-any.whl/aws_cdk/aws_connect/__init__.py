...
class CfnHoursOfOperation(
    ...
    class HoursOfOperationConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HoursOfOperationConfigProperty.__init__)
    ...
    class HoursOfOperationTimeSliceProperty:
        def __init__(self, *, hours: jsii.Number, minutes: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HoursOfOperationTimeSliceProperty.__init__)
...
class CfnQuickConnect(
    ...
    class PhoneNumberQuickConnectConfigProperty:
        def __init__(self, *, phone_number: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PhoneNumberQuickConnectConfigProperty.__init__)
    ...
    class QueueQuickConnectConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(QueueQuickConnectConfigProperty.__init__)
    ...
    class QuickConnectConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(QuickConnectConfigProperty.__init__)
    ...
    class UserQuickConnectConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(UserQuickConnectConfigProperty.__init__)
                check_type(argname="argument contact_flow_arn", value=contact_flow_arn, expected_type=type_hints["contact_flow_arn"])
...
class CfnTaskTemplate(
    ...
    class DefaultFieldValueProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DefaultFieldValueProperty.__init__)
    ...
    class FieldIdentifierProperty:
        def __init__(self, *, name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FieldIdentifierProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
            }
    ...
    class FieldProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FieldProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
                check_type(argname="argument description", value=description, expected_type=type_hints["description"])
    ...
    class UserIdentityInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(UserIdentityInfoProperty.__init__)
    ...
    class UserPhoneConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(UserPhoneConfigProperty.__init__)
