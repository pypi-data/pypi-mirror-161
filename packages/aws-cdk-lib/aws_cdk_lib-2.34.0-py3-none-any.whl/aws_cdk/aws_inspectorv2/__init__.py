...
class CfnFilter(
    ...
    class DateFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DateFilterProperty.__init__)
    ...
    class FilterCriteriaProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FilterCriteriaProperty.__init__)
    ...
    class MapFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MapFilterProperty.__init__)
    ...
    class NumberFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NumberFilterProperty.__init__)
    ...
    class PackageFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PackageFilterProperty.__init__)
    ...
    class PortRangeFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PortRangeFilterProperty.__init__)
    ...
    class StringFilterProperty:
        def __init__(self, *, comparison: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StringFilterProperty.__init__)
                check_type(argname="argument comparison", value=comparison, expected_type=type_hints["comparison"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {
                "comparison": comparison,
