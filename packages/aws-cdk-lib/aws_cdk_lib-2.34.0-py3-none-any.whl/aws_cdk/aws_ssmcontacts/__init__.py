    ...
    class ChannelTargetInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ChannelTargetInfoProperty.__init__)
    ...
    class ContactTargetInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ContactTargetInfoProperty.__init__)
    ...
    class StageProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StageProperty.__init__)
