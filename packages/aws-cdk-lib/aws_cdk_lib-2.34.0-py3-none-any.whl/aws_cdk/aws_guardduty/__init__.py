    ...
    class CFNDataSourceConfigurationsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CFNDataSourceConfigurationsProperty.__init__)
    ...
    class CFNKubernetesAuditLogsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CFNKubernetesAuditLogsConfigurationProperty.__init__)
    ...
    class CFNKubernetesConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CFNKubernetesConfigurationProperty.__init__)
    ...
    class CFNS3LogsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CFNS3LogsConfigurationProperty.__init__)
                check_type(argname="argument enable", value=enable, expected_type=type_hints["enable"])
            self._values: typing.Dict[str, typing.Any] = {}
            if enable is not None:
                self._values["enable"] = enable
    ...
    class FindingCriteriaProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FindingCriteriaProperty.__init__)
