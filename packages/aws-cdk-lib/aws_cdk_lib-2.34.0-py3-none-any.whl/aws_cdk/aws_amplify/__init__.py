    ...
    class AutoBranchCreationConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AutoBranchCreationConfigProperty.__init__)
    ...
    class BasicAuthConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BasicAuthConfigProperty.__init__)
    ...
    class CustomRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomRuleProperty.__init__)
...
class CfnDomain(
    ...
    class SubDomainSettingProperty:
        def __init__(self, *, branch_name: builtins.str, prefix: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SubDomainSettingProperty.__init__)
                check_type(argname="argument branch_name", value=branch_name, expected_type=type_hints["branch_name"])
