    ...
    class RobotSoftwareSuiteProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RobotSoftwareSuiteProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    class SourceConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SourceConfigProperty.__init__)
...
class CfnSimulationApplication(
    ...
    class RenderingEngineProperty:
        def __init__(self, *, name: builtins.str, version: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RenderingEngineProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
                check_type(argname="argument version", value=version, expected_type=type_hints["version"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
    ...
    class SimulationSoftwareSuiteProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SimulationSoftwareSuiteProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
                check_type(argname="argument version", value=version, expected_type=type_hints["version"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
