    ...
    class SNSConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SNSConfigurationProperty.__init__)
                check_type(argname="argument role_arn", value=role_arn, expected_type=type_hints["role_arn"])
...
class CfnAnomalyDetector(
    ...
    class AnomalyDetectorConfigProperty:
        def __init__(self, *, anomaly_detector_frequency: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AnomalyDetectorConfigProperty.__init__)
    ...
    class AppFlowConfigProperty:
        def __init__(self, *, flow_name: builtins.str, role_arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AppFlowConfigProperty.__init__)
    ...
    class CloudwatchConfigProperty:
        def __init__(self, *, role_arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CloudwatchConfigProperty.__init__)
                check_type(argname="argument role_arn", value=role_arn, expected_type=type_hints["role_arn"])
            self._values: typing.Dict[str, typing.Any] = {
                "role_arn": role_arn,
            }
    ...
    class CsvFormatDescriptorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CsvFormatDescriptorProperty.__init__)
    ...
    class FileFormatDescriptorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FileFormatDescriptorProperty.__init__)
    ...
    class JsonFormatDescriptorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(JsonFormatDescriptorProperty.__init__)
                check_type(argname="argument charset", value=charset, expected_type=type_hints["charset"])
                check_type(argname="argument file_compression", value=file_compression, expected_type=type_hints["file_compression"])
            self._values: typing.Dict[str, typing.Any] = {}
            if charset is not None:
    ...
    class MetricSetProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricSetProperty.__init__)
    ...
    class MetricSourceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MetricSourceProperty.__init__)
    ...
    class RDSSourceConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RDSSourceConfigProperty.__init__)
    ...
    class RedshiftSourceConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RedshiftSourceConfigProperty.__init__)
    ...
    class S3SourceConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(S3SourceConfigProperty.__init__)
    ...
    class TimestampColumnProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TimestampColumnProperty.__init__)
