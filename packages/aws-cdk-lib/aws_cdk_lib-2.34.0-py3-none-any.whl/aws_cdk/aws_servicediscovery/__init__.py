...
class CfnPrivateDnsNamespace(
    ...
    class PrivateDnsPropertiesMutableProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PrivateDnsPropertiesMutableProperty.__init__)
    ...
    class PropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PropertiesProperty.__init__)
    ...
    class SOAProperty:
        def __init__(self, *, ttl: typing.Optional[jsii.Number] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SOAProperty.__init__)
    ...
    class PublicDnsPropertiesMutableProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PublicDnsPropertiesMutableProperty.__init__)
                check_type(argname="argument soa", value=soa, expected_type=type_hints["soa"])
            self._values: typing.Dict[str, typing.Any] = {}
            if soa is not None:
                self._values["soa"] = soa
...
class CfnService(
    ...
    class DnsConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DnsConfigProperty.__init__)
    ...
    class DnsRecordProperty:
        def __init__(self, *, ttl: jsii.Number, type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DnsRecordProperty.__init__)
                check_type(argname="argument ttl", value=ttl, expected_type=type_hints["ttl"])
    ...
    class HealthCheckCustomConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HealthCheckCustomConfigProperty.__init__)
                check_type(argname="argument failure_threshold", value=failure_threshold, expected_type=type_hints["failure_threshold"])
            self._values: typing.Dict[str, typing.Any] = {}
            if failure_threshold is not None:
                self._values["failure_threshold"] = failure_threshold
