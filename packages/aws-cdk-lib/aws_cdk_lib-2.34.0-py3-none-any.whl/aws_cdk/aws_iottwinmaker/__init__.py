...
class CfnComponentType(
    ...
    class DataConnectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DataConnectorProperty.__init__)
    ...
    class DataTypeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DataTypeProperty.__init__)
    ...
    class DataValueProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DataValueProperty.__init__)
    ...
    class LambdaFunctionProperty:
        def __init__(self, *, arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LambdaFunctionProperty.__init__)
    ...
    class PropertyDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PropertyDefinitionProperty.__init__)
    ...
    class RelationshipProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RelationshipProperty.__init__)
    ...
    class ComponentProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentProperty.__init__)
    ...
    class PropertyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PropertyProperty.__init__)
    ...
    class StatusProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StatusProperty.__init__)
