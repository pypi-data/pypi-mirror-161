    ...
    class ScheduleConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ScheduleConfigProperty.__init__)
...
class CfnEventIntegration(
    ...
    class EventFilterProperty:
        def __init__(self, *, source: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EventFilterProperty.__init__)
    ...
    class EventIntegrationAssociationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EventIntegrationAssociationProperty.__init__)
