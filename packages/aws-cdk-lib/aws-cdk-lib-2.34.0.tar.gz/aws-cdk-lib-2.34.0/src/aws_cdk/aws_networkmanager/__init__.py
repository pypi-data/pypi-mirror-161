...
class CfnConnectAttachment(
    ...
    class ConnectAttachmentOptionsProperty:
        def __init__(self, *, protocol: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConnectAttachmentOptionsProperty.__init__)
...
class CfnConnectPeer(
    ...
    class BgpOptionsProperty:
        def __init__(self, *, peer_asn: typing.Optional[jsii.Number] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BgpOptionsProperty.__init__)
    ...
    class CoreNetworkEdgeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CoreNetworkEdgeProperty.__init__)
    ...
    class CoreNetworkSegmentProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CoreNetworkSegmentProperty.__init__)
    ...
    class BandwidthProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BandwidthProperty.__init__)
