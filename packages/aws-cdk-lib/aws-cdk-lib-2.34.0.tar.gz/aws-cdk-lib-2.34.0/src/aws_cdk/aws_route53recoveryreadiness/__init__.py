...
class CfnResourceSet(
    ...
    class DNSTargetResourceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DNSTargetResourceProperty.__init__)
    ...
    class NLBResourceProperty:
        def __init__(self, *, arn: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NLBResourceProperty.__init__)
    ...
    class R53ResourceRecordProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(R53ResourceRecordProperty.__init__)
                check_type(argname="argument domain_name", value=domain_name, expected_type=type_hints["domain_name"])
                check_type(argname="argument record_set_id", value=record_set_id, expected_type=type_hints["record_set_id"])
            self._values: typing.Dict[str, typing.Any] = {}
            if domain_name is not None:
    ...
    class TargetResourceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TargetResourceProperty.__init__)
