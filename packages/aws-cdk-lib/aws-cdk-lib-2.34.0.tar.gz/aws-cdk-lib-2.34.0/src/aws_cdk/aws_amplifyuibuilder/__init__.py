...
class CfnComponent(
    ...
    class ActionParametersProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ActionParametersProperty.__init__)
    ...
    class ComponentBindingPropertiesValuePropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentBindingPropertiesValuePropertiesProperty.__init__)
    ...
    class ComponentBindingPropertiesValueProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentBindingPropertiesValueProperty.__init__)
    ...
    class ComponentChildProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentChildProperty.__init__)
    ...
    class ComponentConditionPropertyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentConditionPropertyProperty.__init__)
    ...
    class ComponentDataConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentDataConfigurationProperty.__init__)
                check_type(argname="argument model", value=model, expected_type=type_hints["model"])
    ...
    class ComponentEventProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentEventProperty.__init__)
    ...
    class ComponentPropertyBindingPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentPropertyBindingPropertiesProperty.__init__)
                check_type(argname="argument property", value=property, expected_type=type_hints["property"])
                check_type(argname="argument field", value=field, expected_type=type_hints["field"])
            self._values: typing.Dict[str, typing.Any] = {
                "property": property,
    ...
    class ComponentPropertyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentPropertyProperty.__init__)
                check_type(argname="argument binding_properties", value=binding_properties, expected_type=type_hints["binding_properties"])
    ...
    class ComponentVariantProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComponentVariantProperty.__init__)
    ...
    class MutationActionSetStateParameterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MutationActionSetStateParameterProperty.__init__)
                check_type(argname="argument component_name", value=component_name, expected_type=type_hints["component_name"])
                check_type(argname="argument property", value=property, expected_type=type_hints["property"])
    ...
    class SortPropertyProperty:
        def __init__(self, *, direction: builtins.str, field: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SortPropertyProperty.__init__)
    ...
    class ThemeValueProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ThemeValueProperty.__init__)
                check_type(argname="argument children", value=children, expected_type=type_hints["children"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if children is not None:
    ...
    class ThemeValuesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ThemeValuesProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {}
            if key is not None:
