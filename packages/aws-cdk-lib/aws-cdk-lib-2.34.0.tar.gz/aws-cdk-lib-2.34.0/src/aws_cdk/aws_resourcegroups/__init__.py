    ...
    class ConfigurationItemProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigurationItemProperty.__init__)
    ...
    class ConfigurationParameterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigurationParameterProperty.__init__)
    ...
    class QueryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(QueryProperty.__init__)
    ...
    class ResourceQueryProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ResourceQueryProperty.__init__)
