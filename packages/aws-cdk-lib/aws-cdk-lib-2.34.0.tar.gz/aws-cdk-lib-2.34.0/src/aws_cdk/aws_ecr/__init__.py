...
class CfnReplicationConfiguration(
    ...
    class RepositoryFilterProperty:
        def __init__(self, *, filter: builtins.str, filter_type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RepositoryFilterProperty.__init__)
    ...
    class ImageScanningConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ImageScanningConfigurationProperty.__init__)
    ...
    class LifecyclePolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LifecyclePolicyProperty.__init__)
