    ...
    *Private Hosted Zones*
    ...
    class AlarmIdentifierProperty:
        def __init__(self, *, name: builtins.str, region: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AlarmIdentifierProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    class HealthCheckTagProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HealthCheckTagProperty.__init__)
...
class CfnHostedZone(
    ...
    class HostedZoneConfigProperty:
        def __init__(self, *, comment: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HostedZoneConfigProperty.__init__)
    ...
    class HostedZoneTagProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(HostedZoneTagProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {
                "key": key,
    ...
    class QueryLoggingConfigProperty:
        def __init__(self, *, cloud_watch_logs_log_group_arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(QueryLoggingConfigProperty.__init__)
    ...
    class AliasTargetProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AliasTargetProperty.__init__)
                check_type(argname="argument dns_name", value=dns_name, expected_type=type_hints["dns_name"])
                check_type(argname="argument hosted_zone_id", value=hosted_zone_id, expected_type=type_hints["hosted_zone_id"])
    ...
    class CidrRoutingConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CidrRoutingConfigProperty.__init__)
    ...
    class GeoLocationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(GeoLocationProperty.__init__)
    ...
    class RecordSetProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RecordSetProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
