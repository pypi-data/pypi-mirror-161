...
class CfnEventDataStore(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        advanced_event_selectors: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union["CfnEventDataStore.AdvancedEventSelectorProperty", _IResolvable_da3f097b]]]] = None,
    ...
    class AdvancedEventSelectorProperty:
        def __init__(
            self,
            *,
            field_selectors: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union["CfnEventDataStore.AdvancedFieldSelectorProperty", _IResolvable_da3f097b]]],
            name: typing.Optional[builtins.str] = None,
        ) -> None:
            '''
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AdvancedEventSelectorProperty.__init__)
    ...
    class AdvancedFieldSelectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AdvancedFieldSelectorProperty.__init__)
    ...
    class DataResourceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DataResourceProperty.__init__)
    ...
    class EventSelectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EventSelectorProperty.__init__)
    ...
    class InsightSelectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(InsightSelectorProperty.__init__)
