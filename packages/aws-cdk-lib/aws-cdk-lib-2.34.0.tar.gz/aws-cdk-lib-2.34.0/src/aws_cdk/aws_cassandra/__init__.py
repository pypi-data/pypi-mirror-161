    ...
    class BillingModeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BillingModeProperty.__init__)
    ...
    class ClusteringKeyColumnProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ClusteringKeyColumnProperty.__init__)
    ...
    class EncryptionSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EncryptionSpecificationProperty.__init__)
