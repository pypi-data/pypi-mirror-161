    ...
    class FirewallRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FirewallRuleProperty.__init__)
    ...
    class IpAddressRequestProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(IpAddressRequestProperty.__init__)
    ...
    class TargetAddressProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TargetAddressProperty.__init__)
                check_type(argname="argument ip", value=ip, expected_type=type_hints["ip"])
