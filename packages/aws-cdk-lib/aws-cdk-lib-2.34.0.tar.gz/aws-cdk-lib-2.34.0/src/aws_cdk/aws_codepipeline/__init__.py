    ...
    class ArtifactDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ArtifactDetailsProperty.__init__)
    ...
    class ConfigurationPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigurationPropertiesProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    class SettingsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(SettingsProperty.__init__)
...
class CfnPipeline(
    ...
    class ActionDeclarationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ActionDeclarationProperty.__init__)
    ...
    class ActionTypeIdProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ActionTypeIdProperty.__init__)
                check_type(argname="argument category", value=category, expected_type=type_hints["category"])
                check_type(argname="argument owner", value=owner, expected_type=type_hints["owner"])
                check_type(argname="argument provider", value=provider, expected_type=type_hints["provider"])
                check_type(argname="argument version", value=version, expected_type=type_hints["version"])
    ...
    class ArtifactStoreMapProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ArtifactStoreMapProperty.__init__)
    ...
    class ArtifactStoreProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ArtifactStoreProperty.__init__)
    ...
    class BlockerDeclarationProperty:
        def __init__(self, *, name: builtins.str, type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BlockerDeclarationProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
    ...
    class EncryptionKeyProperty:
        def __init__(self, *, id: builtins.str, type: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EncryptionKeyProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
                check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            self._values: typing.Dict[str, typing.Any] = {
                "id": id,
    ...
    class InputArtifactProperty:
        def __init__(self, *, name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(InputArtifactProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
            }
    ...
    class OutputArtifactProperty:
        def __init__(self, *, name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(OutputArtifactProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            self._values: typing.Dict[str, typing.Any] = {
                "name": name,
            }
    ...
    class StageDeclarationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StageDeclarationProperty.__init__)
    ...
    class StageTransitionProperty:
        def __init__(self, *, reason: builtins.str, stage_name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StageTransitionProperty.__init__)
    ...
    class WebhookAuthConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(WebhookAuthConfigurationProperty.__init__)
    ...
    class WebhookFilterRuleProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(WebhookFilterRuleProperty.__init__)
