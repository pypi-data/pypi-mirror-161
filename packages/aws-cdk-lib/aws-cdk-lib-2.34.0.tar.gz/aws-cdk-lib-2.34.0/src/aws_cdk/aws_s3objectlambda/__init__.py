    ...
    class ObjectLambdaConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ObjectLambdaConfigurationProperty.__init__)
    ...
    class TransformationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TransformationConfigurationProperty.__init__)
