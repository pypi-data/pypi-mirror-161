    ...
    class ScriptDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ScriptDetailsProperty.__init__)
    ...
    class ServiceAccountCredentialsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ServiceAccountCredentialsProperty.__init__)
...
class CfnFleet(
    ...
    class ComputeCapacityProperty:
        def __init__(self, *, desired_instances: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComputeCapacityProperty.__init__)
    ...
    class DomainJoinInfoProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DomainJoinInfoProperty.__init__)
                check_type(argname="argument directory_name", value=directory_name, expected_type=type_hints["directory_name"])
    ...
    class AccessEndpointProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AccessEndpointProperty.__init__)
...
class CfnStack(
    ...
    def __init__(
        ...
        *,
        ...
        streaming_experience_settings: typing.Optional[typing.Union["CfnStack.StreamingExperienceSettingsProperty", _IResolvable_da3f097b]] = None,
        tags: typing.Optional[typing.Sequence[_CfnTag_f6864754]] = None,
    ...
    class ApplicationSettingsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ApplicationSettingsProperty.__init__)
    ...
    class StorageConnectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StorageConnectorProperty.__init__)
    ...
    class StreamingExperienceSettingsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(StreamingExperienceSettingsProperty.__init__)
    ...
    class UserSettingProperty:
        def __init__(self, *, action: builtins.str, permission: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(UserSettingProperty.__init__)
