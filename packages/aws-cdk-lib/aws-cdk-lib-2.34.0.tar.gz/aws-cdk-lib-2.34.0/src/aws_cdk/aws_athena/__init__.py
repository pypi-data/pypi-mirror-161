    ...
    class EngineVersionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EngineVersionProperty.__init__)
    ...
    class ResultConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ResultConfigurationProperty.__init__)
    ...
    class WorkGroupConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(WorkGroupConfigurationProperty.__init__)
