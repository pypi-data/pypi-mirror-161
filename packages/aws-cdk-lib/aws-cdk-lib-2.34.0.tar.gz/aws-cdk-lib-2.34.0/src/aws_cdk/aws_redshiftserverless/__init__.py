...
class CfnWorkgroup(
    ...
    def __init__(
        ...
        *,
        ...
        config_parameters: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union["CfnWorkgroup.ConfigParameterProperty", _IResolvable_da3f097b]]]] = None,
    ...
    class ConfigParameterProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigParameterProperty.__init__)
