    ...
    class ApplicationSourceProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ApplicationSourceProperty.__init__)
    ...
    class CustomizedLoadMetricSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomizedLoadMetricSpecificationProperty.__init__)
    ...
    class CustomizedScalingMetricSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomizedScalingMetricSpecificationProperty.__init__)
                check_type(argname="argument metric_name", value=metric_name, expected_type=type_hints["metric_name"])
                check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
                check_type(argname="argument statistic", value=statistic, expected_type=type_hints["statistic"])
                check_type(argname="argument dimensions", value=dimensions, expected_type=type_hints["dimensions"])
    ...
    class PredefinedLoadMetricSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PredefinedLoadMetricSpecificationProperty.__init__)
    ...
    class PredefinedScalingMetricSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PredefinedScalingMetricSpecificationProperty.__init__)
    ...
    class ScalingInstructionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ScalingInstructionProperty.__init__)
