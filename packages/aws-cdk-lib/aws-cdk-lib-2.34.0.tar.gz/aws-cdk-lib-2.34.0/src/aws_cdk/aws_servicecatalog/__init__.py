    ...
    class ProvisioningArtifactPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProvisioningArtifactPropertiesProperty.__init__)
...
class CfnCloudFormationProvisionedProduct(
    ...
    class ProvisioningParameterProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProvisioningParameterProperty.__init__)
    ...
    class ProvisioningPreferencesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ProvisioningPreferencesProperty.__init__)
...
class CfnServiceAction(
    ...
    class DefinitionParameterProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(DefinitionParameterProperty.__init__)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[str, typing.Any] = {
                "key": key,
