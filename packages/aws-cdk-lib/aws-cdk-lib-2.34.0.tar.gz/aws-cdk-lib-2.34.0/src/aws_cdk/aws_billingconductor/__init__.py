...
class CfnBillingGroup(
    ...
    class AccountGroupingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AccountGroupingProperty.__init__)
    ...
    class ComputationPreferenceProperty:
        def __init__(self, *, pricing_plan_arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ComputationPreferenceProperty.__init__)
...
class CfnCustomLineItem(
    ...
    class BillingPeriodRangeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(BillingPeriodRangeProperty.__init__)
    ...
    class CustomLineItemChargeDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomLineItemChargeDetailsProperty.__init__)
    ...
    class CustomLineItemFlatChargeDetailsProperty:
        def __init__(self, *, charge_value: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomLineItemFlatChargeDetailsProperty.__init__)
    ...
    class CustomLineItemPercentageChargeDetailsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CustomLineItemPercentageChargeDetailsProperty.__init__)
