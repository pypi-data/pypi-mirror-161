...
class CfnIntegration(
    ...
    class FlowDefinitionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FlowDefinitionProperty.__init__)
    ...
    class ObjectTypeMappingProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ObjectTypeMappingProperty.__init__)
    ...
    class TaskPropertiesMapProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TaskPropertiesMapProperty.__init__)
    ...
    class TriggerPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TriggerPropertiesProperty.__init__)
    ...
    class FieldMapProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FieldMapProperty.__init__)
    ...
    class KeyMapProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(KeyMapProperty.__init__)
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    class ObjectTypeFieldProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ObjectTypeFieldProperty.__init__)
    ...
    class ObjectTypeKeyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ObjectTypeKeyProperty.__init__)
