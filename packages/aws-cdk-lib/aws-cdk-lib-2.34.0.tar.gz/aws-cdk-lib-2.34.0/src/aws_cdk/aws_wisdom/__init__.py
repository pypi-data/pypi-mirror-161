...
class CfnAssistantAssociation(
    ...
    class AssociationDataProperty:
        def __init__(self, *, knowledge_base_id: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AssociationDataProperty.__init__)
    ...
    class AppIntegrationsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(AppIntegrationsConfigurationProperty.__init__)
    ...
    class RenderingConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(RenderingConfigurationProperty.__init__)
