...
class CfnBroker(
    ...
    class ConfigurationIdProperty:
        def __init__(self, *, id: builtins.str, revision: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ConfigurationIdProperty.__init__)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    class EncryptionOptionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(EncryptionOptionsProperty.__init__)
    ...
    class LdapServerMetadataProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LdapServerMetadataProperty.__init__)
    ...
    class LogListProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(LogListProperty.__init__)
    ...
    class MaintenanceWindowProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MaintenanceWindowProperty.__init__)
    ...
    class TagsEntryProperty:
        def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(TagsEntryProperty.__init__)
