...
class CfnMember(
    ...
    class ApprovalThresholdPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ApprovalThresholdPolicyProperty.__init__)
    ...
    class MemberConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MemberConfigurationProperty.__init__)
    ...
    class MemberFabricConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MemberFabricConfigurationProperty.__init__)
    ...
    class MemberFrameworkConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(MemberFrameworkConfigurationProperty.__init__)
    ...
    class NetworkFabricConfigurationProperty:
        def __init__(self, *, edition: builtins.str) -> None:
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NetworkFabricConfigurationProperty.__init__)
    ...
    class NetworkFrameworkConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NetworkFrameworkConfigurationProperty.__init__)
    ...
    class VotingPolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(VotingPolicyProperty.__init__)
    ...
    class NodeConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(NodeConfigurationProperty.__init__)
