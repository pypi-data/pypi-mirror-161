    ...
    class PhysicalResourceIdProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(PhysicalResourceIdProperty.__init__)
    ...
    class ResourceMappingProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(ResourceMappingProperty.__init__)
    ...
    class FailurePolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(FailurePolicyProperty.__init__)
