...
def main():
    ...
    git_hash = await datadogCi.gitMetadata.uploadGitCommitHash('{Datadog_API_Key}', '<SITE>')
...
class ILambdaFunction(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_ILambdaFunctionProxy"]:
        return _ILambdaFunctionProxy
...
class Transport(
    ...
    def __init__(
        ...
        :param extension_layer_version: -
        '''
        jsii.create(Transport, self, [flush_metrics_to_logs, site, api_key, api_key_secret_arn, api_kms_key, extension_layer_version])
