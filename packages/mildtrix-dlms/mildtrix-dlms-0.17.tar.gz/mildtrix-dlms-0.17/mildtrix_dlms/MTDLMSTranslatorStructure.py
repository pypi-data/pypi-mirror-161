...
class MTDLMSTranslatorStructure:
    """
    This class is used internally in MTDLMSTranslator to save generated XML.
    """
    ...
    def getDataType(self, type_):
        return self.__getTag(_MTCommon.DATA_TYPE_OFFSET + type_)
    ...
    def integerToHex(self, value, desimals, forceHex=False):
        if forceHex or (self.showNumericsAsHex and self.outputType == TranslatorOutputType.SIMPLE_XML):
            return _MTCommon.integerToHex(value, desimals)
        return str(value)
