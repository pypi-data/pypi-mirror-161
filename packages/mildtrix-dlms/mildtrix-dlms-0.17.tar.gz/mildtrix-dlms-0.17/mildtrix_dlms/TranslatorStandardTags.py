...
class TranslatorStandardTags:
    ...
    def getDataTypeTags(cls, list_):
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.NONE] = "null-data"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.ARRAY] = "array"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.BCD] = "bcd"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.BITSTRING] = "bit-string"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.BOOLEAN] = "boolean"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.COMPACT_ARRAY] = "compact-array"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.DATE] = "date"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.DATETIME] = "date-time"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.ENUM] = "enum"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.FLOAT32] = "float32"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.FLOAT64] = "float64,"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT16] = "long"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT32] = "double-long"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT64] = "long64"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT8] = "integer"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.OCTET_STRING] = "octet-string"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.STRING] = "visible-string"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.STRING_UTF8] = "utf8-string"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.STRUCTURE] = "structure"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.TIME] = "time"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT16] = "long-unsigned"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT32] = "double-long-unsigned"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT64] = "long64-unsigned"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT8] = "unsigned"
