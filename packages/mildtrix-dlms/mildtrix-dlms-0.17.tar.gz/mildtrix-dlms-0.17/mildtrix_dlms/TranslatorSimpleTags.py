...
class TranslatorSimpleTags:
    ...
    def getDataTypeTags(cls, list_):
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.NONE] = "None"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.ARRAY] = "Array"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.BCD] = "BCD"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.BITSTRING] = "BitString"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.BOOLEAN] = "Boolean"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.COMPACT_ARRAY] = "CompactArray"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.DATE] = "Date"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.DATETIME] = "DateTime"
        ...
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT16] = "Int16"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT32] = "Int32"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT64] = "Int64"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.INT8] = "Int8"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.OCTET_STRING] = "OctetString"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.STRING] = "String"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.STRING_UTF8] = "StringUTF8"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.STRUCTURE] = "Structure"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.TIME] = "Time"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT16] = "UInt16"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT32] = "UInt32"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT64] = "UInt64"
        list_[_MTCommon.DATA_TYPE_OFFSET + DataType.UINT8] = "UInt8"
