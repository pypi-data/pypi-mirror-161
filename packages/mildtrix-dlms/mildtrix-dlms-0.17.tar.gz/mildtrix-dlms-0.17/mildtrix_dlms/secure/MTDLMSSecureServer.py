...
class MTDLMSSecureServer(MTDLMSServer):
    ...
    def __init__(self, association, interfaceType):
        ...
        super(MTDLMSSecureServer, self).__init__(association, interfaceType)
        self.settings.ciphering = MTCiphering("ABCDEFGH".encode())
        self.kek = None
