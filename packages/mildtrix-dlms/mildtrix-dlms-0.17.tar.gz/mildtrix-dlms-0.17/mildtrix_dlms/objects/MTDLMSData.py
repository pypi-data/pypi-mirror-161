...
class MTDLMSData(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSData
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.DATA, ln, sn)
        self.value = None
    ...
    def getDataType(self, index):
        ...
        if index == 2:
            ...
            return super(MTDLMSData, self).getDataType(index)
