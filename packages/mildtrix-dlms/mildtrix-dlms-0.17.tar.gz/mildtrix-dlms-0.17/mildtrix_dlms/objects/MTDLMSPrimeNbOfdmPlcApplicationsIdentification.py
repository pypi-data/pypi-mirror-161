...
class MTDLMSPrimeNbOfdmPlcApplicationsIdentification(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSPrimeNbOfdmPlcApplicationsIdentification
    """
    ...
    def __init__(self, ln="0.0.28.7.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_APPLICATIONS_IDENTIFICATION, ln, sn)
