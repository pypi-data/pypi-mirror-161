...
class MTDLMSCredit(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSCredit
    """
    ...
    def __init__(self, ln="0.0.19.10.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.CREDIT, ln, sn)
    ...
    def getValue(self, settings, e):
        ...
        if e.index == 1:
            ...
            ret = MTBitString.toBitString(self.creditConfiguration, 5)
        elif e.index == 8:
            ret = self.status
        elif e.index == 9:
