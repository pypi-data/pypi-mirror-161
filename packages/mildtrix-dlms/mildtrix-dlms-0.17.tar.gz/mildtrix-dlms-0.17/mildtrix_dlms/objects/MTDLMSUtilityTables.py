...
class MTDLMSUtilityTables(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSUtilityTables
    """
    ...
    def __init__(self, ln="0.0.65.0.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.UTILITY_TABLES, ln, sn)
        # Table Id.
        self.tableId = 0
    ...
    def load(self, reader):
        ...
        self.buffer = MTByteBuffer.hexToBytes(reader.readElementContentAsString("Buffer"))

    def save(self, writer):
        writer.writeElementString("Id", self.tableId, False)
        writer.writeElementString("Buffer", MTByteBuffer.hex(self.buffer))
