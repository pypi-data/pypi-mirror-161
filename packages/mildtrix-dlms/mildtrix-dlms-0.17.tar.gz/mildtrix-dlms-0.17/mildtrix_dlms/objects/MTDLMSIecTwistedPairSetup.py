...
class MTDLMSIecTwistedPairSetup(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSIecTwistedPairSetup
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.IEC_HDLC_SETUP, ln, sn)
        # Working mode.
    ...
    def load(self, reader):
        ...
        self.primaryAddresses = MTByteBuffer.hexToBytes(reader.readElementContentAsString("PrimaryAddresses"))
        self.tabis = MTByteBuffer.hexToBytes(reader.readElementContentAsString("Tabis"))

    def save(self, writer):
        writer.writeElementString("Mode", self.mode)
        writer.writeElementString("Speed", self.speed)
        writer.writeElementString("LN", MTByteBuffer.hex(self.primaryAddresses))
        if self.tabis:
            writer.writeElementString("LN", MTByteBuffer.hex(self.tabis))
