...
class MTDLMSDemandRegister(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSDemandRegister
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.DEMAND_REGISTER, ln, sn)
    ...
    def isRead(self, index):
        ...
        return super(MTDLMSDemandRegister, self).isRead(index)
    ...
    def getDataType(self, index):
        ...
        if index == 1:
            ...
            ret = super(MTDLMSDemandRegister, self).getDataType(index)
        elif index == 3:
            ret = super(MTDLMSDemandRegister, self).getDataType(index)
        elif index == 4:
            ret = DataType.ARRAY
