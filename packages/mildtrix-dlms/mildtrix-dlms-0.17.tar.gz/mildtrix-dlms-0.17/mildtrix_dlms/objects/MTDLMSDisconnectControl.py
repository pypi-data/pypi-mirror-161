...
class MTDLMSDisconnectControl(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSDisconnectControl
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.DISCONNECT_CONTROL, ln, sn)
