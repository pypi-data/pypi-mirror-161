...
class MTDLMSMBusMasterPortSetup(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSMBusMasterPortSetup
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        super(MTDLMSMBusMasterPortSetup, self).__init__(ObjectType.MBUS_MASTER_PORT_SETUP, ln, sn)
