...
class MTDLMSLlcSscsSetup(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSLlcSscsSetup
    """
    ...
    def __init__(self, ln="0.0.28.0.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.LLC_SSCS_SETUP, ln, sn)
