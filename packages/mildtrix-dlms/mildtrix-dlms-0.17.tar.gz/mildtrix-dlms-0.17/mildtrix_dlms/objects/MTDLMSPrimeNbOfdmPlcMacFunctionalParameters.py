...
class MTDLMSPrimeNbOfdmPlcMacFunctionalParameters(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSPrimeNbOfdmPlcMacFunctionalParameters
    """
    ...
    def __init__(self, ln="0.0.28.3.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_MAC_FUNCTIONAL_PARAMETERS, ln, sn)
    ...
    def load(self, reader):
        ...
        self.sna = MTByteBuffer.hexToBytes(reader.readElementContentAsString("SNa"))
