...
class MTDLMSMBusSlavePortSetup(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSMBusSlavePortSetup
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        super(MTDLMSMBusSlavePortSetup, self).__init__(ObjectType.MBUS_SLAVE_PORT_SETUP, ln, sn)
