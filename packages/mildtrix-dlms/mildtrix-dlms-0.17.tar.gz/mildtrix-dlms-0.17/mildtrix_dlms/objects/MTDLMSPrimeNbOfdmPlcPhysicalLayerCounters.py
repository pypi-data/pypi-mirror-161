...
class MTDLMSPrimeNbOfdmPlcPhysicalLayerCounters(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSPrimeNbOfdmPlcPhysicalLayerCounters
    """
    ...
    def __init__(self, ln="0.0.28.1.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_PHYSICAL_LAYER_COUNTERS, ln, sn)
