...
class MTDLMSPrimeNbOfdmPlcMacSetup(MTDLMSObject, IMTDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/mildtrix.DLMS.Objects.MTDLMSPrimeNbOfdmPlcMacSetup
    """
    ...
    def __init__(self, ln="0.0.28.2.0.255", sn=0):
        ...
        """
        MTDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_MAC_SETUP, ln, sn)
