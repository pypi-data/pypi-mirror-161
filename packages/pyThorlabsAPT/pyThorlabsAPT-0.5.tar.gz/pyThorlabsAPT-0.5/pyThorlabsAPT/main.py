...
class gui(abstract_instrument_interface.abstract_gui):
    ...
    def create_widgets(self):
        ...
        self.widgets_disabled_when_moving = [self.button_StartRamp,self.button_set_stageparams,self.button_MoveNegative ,self.button_MovePositive,self.button_Home]
