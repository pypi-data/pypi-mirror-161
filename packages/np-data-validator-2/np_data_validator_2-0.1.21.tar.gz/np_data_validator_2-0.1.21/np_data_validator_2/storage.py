...
def get_asset_validation_results(
    table, lims_id: str, asset_type: str = None
) -> AssetValidationResult:
    query = {"lims_id": lims_id}
    if asset_type is not None:
        query["manifest.asset_type"] = asset_type
    data = table.find(query, {"_id": False})
