...
def validations(
    db_address: str,
    lims_id: str,
    asset_type: Optional[str] = typer.Argument(None),
) -> None:
    client = MongoClient(db_address)
    ...
    for validation in validations:
        console.print("Asset type: %s" % validation.manifest.asset_type)
        validation_dict = from_AssetValidationResult(validation)
        validation_dict.pop(manifest)  # don't display, manifest...TODO do this better?
        console.print(validation_dict)
