...
class QueryLineageParseResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, all_tables, inserts, fingerprint, error, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, all_tables, inserts, fingerprint, error, *args, **kwargs):  # noqa: E501
        """QueryLineageParseResult - a model defined in OpenAPI
