...
if TYPE_CHECKING:
    from ...tl.types import TypeDataJSON, TypeInputInvoice, TypeInputMedia, TypeInputPaymentCredentials, TypeInputPeer, TypeInputUser, TypePaymentRequestedInfo



class AssignAppStoreTransactionRequest(TLRequest):
    CONSTRUCTOR_ID = 0xfec13c6
    SUBCLASS_OF_ID = 0x8af52aac

    def __init__(self, transaction_id: str, receipt: bytes, restore: Optional[bool]=None):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(transaction_id=_transaction_id, receipt=_receipt, restore=_restore)


class AssignPlayMarketTransactionRequest(TLRequest):
    CONSTRUCTOR_ID = 0x4faa4aed
    SUBCLASS_OF_ID = 0x8af52aac

    def __init__(self, purchase_token: str):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
    ...
    def _bytes(self):
        return b''.join((
            b'\xedJ\xaaO',
            self.serialize_bytes(self.purchase_token),
        ))

    @classmethod
    def from_reader(cls, reader):
        _purchase_token = reader.tgread_string()
        return cls(purchase_token=_purchase_token)


class CanPurchasePremiumRequest(TLRequest):
    CONSTRUCTOR_ID = 0xaa6a90c8
...
class RestorePlayMarketReceiptRequest(TLRequest):
    CONSTRUCTOR_ID = 0xd164e36a
    SUBCLASS_OF_ID = 0x8af52aac
    ...
    def to_dict(self):
        return {
            '_': 'RestorePlayMarketReceiptRequest',
            'receipt': self.receipt
        }
