...
from qm.utils import (
    ...
    collection_has_type as _collection_has_type,
    is_iter as _is_iter,
)
...
def for_each_(var, values):
    ...
    for value in values:
        if isinstance(value, _Expression):
            ...
            has_bool = _collection_has_type(value, (bool, np.bool_))
            has_int = _collection_has_type(value, (int, np.integer))
            has_float = _collection_has_type(value, (float, np.floating))
