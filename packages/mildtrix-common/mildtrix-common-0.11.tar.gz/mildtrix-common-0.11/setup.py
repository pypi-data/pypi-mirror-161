...
setup(
  name = 'mildtrix-common',         # How you named your package folder (MyLib)
  packages = ['mildtrix_common','mildtrix_common.enums','mildtrix_common.io'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/ravichandra99/mildtrix-common/archive/v_01.tar.gz',    # I explain this later on
  keywords = ['mildtrix', 'common', 'smartmeter'],   # Keywords that define your package best
